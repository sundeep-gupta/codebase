<?
	...
	$activetab = "testing";
	$titleString = "Program Status Page";
	...
	switch($_SESSION["indexSortCol"]) {
	    case 1: $orderby .= "ppl.number ".$_SESSION["indexSortDir"];
	            break;
	    ...
	    case 4: $orderby .= "Status ".$_SESSION["indexSortDir"];
	            break;
#	    case 5: $orderby .= "Complete ".$_SESSION["indexSortDir"];
#	            break;
      ...
      <tr>
		...
		<table width="100%" cellpadding="4" cellspacing="0" bgcolor="#f9f9f9">
			<tr bgcolor="#E4E4E4">
				...
				<td><b><a href=?sortBy=6>Start Date</a>&nbsp;<?=($_SESSION["indexSortCol"]=="6") ? $SortImg : ""?></b></td>
        <td><b>Complete</b></td>
			</tr>
	        ...
	        <?
				...
				if (isset($_GET["pid"]) && isset($_GET["sid"])) {
					$certs = GetCerts($_GET["pid"], 0, $orderby);
