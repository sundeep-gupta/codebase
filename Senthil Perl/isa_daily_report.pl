...
use DBD::mysql;
use perlchartdir;
$report_date=` date '+%Y-%m-%d' `;chomp($report_date);
...
$c->makeChart("/venket/isa/daily/size$report_date.png");
...
$d->makeChart("/venket/isa/daily/hits$report_date.png");
...
$e->makeChart("/venket/isa/daily/site_hits$report_date.png");
...
$f->makeChart("/venket/isa/daily/site_size$report_date.png");




open (HTMLOUT,">/usr/local/apache/htdocs/isa/daily/report$report_date.html");
printf HTMLOUT <<"EOF";
...
<tr><td width="100%" colspan="2" bgcolor="#F6F6F6"><img border="0" src="/isa/daily/size$report_date.png" width="600" height="250"></td></tr>

<tr><td width="100%" colspan="2" bgcolor="#F6F6F6" colspan="2"><p><b>Top Users by Number of Hits</b></td></tr>
<tr><td width="100%" colspan="2" bgcolor="#F6F6F6"><img border="0" src="/isa/daily/hits$report_date.png" width="600" height="250"></td></tr>

<tr><td width="100%" colspan="2" bgcolor="#F6F6F6" colspan="2"><p><b>Top Sites by Number of Hits</b></td></tr>
<tr><td width="100%" colspan="2" bgcolor="#F6F6F6"><img border="0" src="/isa/daily/site_hits$report_date.png" width="600" height="250"></td></tr>

<tr><td width="100%" colspan="2" bgcolor="#F6F6F6" colspan="2"><p><b>Top Sites by Bytes Transferred</b></td></tr>
<tr><td width="100%" colspan="2" bgcolor="#F6F6F6"><img border="0" src="/isa/daily/site_size$report_date.png" width="600" height="250"></td></tr>
