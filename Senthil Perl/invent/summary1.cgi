...
$sql = qq{ select count(*) from INVENTORY };
...
$sql1 = qq{ select make,count(make) from INVENTORY where location like '10A%' group by make };
...
$sql1 = qq{ select make,count(make) from INVENTORY where location like '10C%' group by make };
...
$sql1 = qq{ select make,count(make) from INVENTORY where location like '10D%' group by make };
...
$sql1 = qq{ select make,count(make) from INVENTORY where location like '11C%' group by make };
