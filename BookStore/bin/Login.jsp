...
/* Load the Driver 
 * Create connection object & statement object
 * 
 */
String sErr = loadDriver();        
conn = cn();				
stat = conn.createStatement();
/* If error during loading of driver then
...
/* if "FormName" parameter value is Login then call LoginAction method 
 * If LoginAction method returns "sendRedirect" error message then return;
 */
...
<body style="background-color: #FFFFFF; color: #000000; font-family: Arial, Tahoma, Verdana, Helvetica">
...
<center>
	<font face="Arial"><small>This dynamic site was generated with <a href="http://www.codecharge.com">CodeCharge</a></small></font>
</center>
</body>
</html>
<%%>
