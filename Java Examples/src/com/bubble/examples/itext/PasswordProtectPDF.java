...
public class PasswordProtectPDF {    
    ...
    public static void main(String[] args){
        try {
            ...
            OwnerPassword = "OpenSesame".getBytes();
            ...
            PdfReader reader = new PdfReader("D:\\data\\Google Drive\\Bank Statements\\FY 2013-14\\Harsha\\Axis Bank - Apr 2013.pdf", null);
            PdfEncryptor.encrypt(reader, new 
            		FileOutputStream("D:\\axix.pdf"), OwnerPassword, null, 
