...
public class DecryptPdfFile {
	public static void main(String... args) {
		String fileName = "D:\\data\\Google Drive\\Bank Statements\\FY 2012-13\\Axis - Apr 2012 - HARS008171410.pdf";
		String outFilename = "D:\\data\\Google Drive\\Bank Statements\\FY 2012-13\\Axis - Apr 2012.pdf";
		byte[] password = null;
		try {
			password = "HARS008171410".getBytes("US-ASCII");
