...
<tr height="50">
	<th  align="center" class="greenHead">	<a href="/kndn/folders.jsp" class="greenLink" onMouseOver=""> <font size="5"> Photos </font> </a>	</th>
</tr>
<%
...
%>
				<tr height="20">
					<td align="center"> <span style="background-color: f22f0e"> <font size="4" color="white" face="verdana"> &nbsp; Sorry, unable to rename the folder - <font size="5"> <%= request.getParameter("oldName") %> </font> &nbsp; </font>	</span> </td>
				</tr>
<%
			}
		}else{
...
%>
				<tr height="20">
					<td align="center"> <span style="background-color: f22f0e"> <font size="4" color="white" face="verdana"> &nbsp; Sorry, unable to create the folder - <font size="5"> <%= file %> </font> &nbsp; </font>	</span> </td>
				</tr>
...
<%
	...
	if(folderNames.length != 0){
		...
		for(int loopCount=0; loopCount < folderNames.length; loopCount++){
			...
			out.println("<td width=\"75%\" align=\"center\"> <a href=\"/kndn/folderContent.jsp?file=Photos/" + folderNames[loopCount] + "\" style=\"TEXT-DECORATION:none\"> <font size=\"5\" face=\"verdana\" color=\"black\">" + folderNames[loopCount] + " </font> </a> </td>");

			out.println("<td> </td>");

			out.println("<td align=\"left\"> <a href=\"/kndn/editFolder.jsp?file=Photos/" + folderNames[loopCount] + "\" style=\"TEXT-DECORATION:none\"> <font size=\"2\"> [ Rename ] </font> </a> </td>");

/*			out.println("<td width=\"50%\" align=\"center\"> <a href=\"/kndn/deleteConfirmation.jsp?file=Photos/" + folderNames[loopCount] + "\" style=\"TEXT-DECORATION:none\"> <font size=\"2\"> [ Delete ] </font> </a> </td>");
*/
...
<tr valign="bottom">
	...
	<hr color="#AC5CEE" size="3" />
		...
		<input type="hidden" name="photorReport" value="Photos" />

		<tr align="center">
			<td>
				<p class="blackText"> Create new folder : 	<input type="text" name="newFolderName" size="15" class="TextField" /> </p>
			</td>
		</tr>
