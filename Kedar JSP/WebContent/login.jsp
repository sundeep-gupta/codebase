...
<tr height="250" valign="bottom">
	<td>
		...
		<form name="adminLogin" method="post" action="/kndn/jsp2.jsp" />
		...
		<tr>
			...
			<td>
				<input type="password" name="adminPasswd" size="12" />
			</td>
		</tr>
...
<tr height="250" valign="bottom">
	<td>
		...
		%>
		<form name="adminLogin" method="post" action="/kndn/userVerify.jsp" />
