...
#system(`echo verylargefiles >> $value10`);
#$scanpath=$value3.'verylargefiles';
#ExecuteTest();
#ExecuteTest();


system(`echo Archives >> $value10`);
$scanpath=$value3.'archives';
ExecuteTest();
#ExecuteTest();

system(`echo Assorted >> $value10`);
$scanpath=$value3.'assorted';
ExecuteTest();
#ExecuteTest();

system(`echo Documents >> $value10`);
$scanpath=$value3.'documents';
ExecuteTest();
#ExecuteTest();

system(`echo Emails >> $value10`);
$scanpath=$value3.'emails';
ExecuteTest();
#ExecuteTest();
