...
system("rm /Volumes/Data/ssm_perf/Reports/app_launch_mod_rep") if (-e "/Volumes/Data/ssm_perf/Reports/app_launch_mod_rep");
open (FP,">/Volumes/Data/ssm_perf/Reports/app_launch_mod_rep");
...
print FP "$var\n";
foreach my $t (@search) {
my $val1 = `cat /Volumes/Data/ssm_perf/Reports/Application-Launch.log | grep '$t'`;
my @tmp1 = split('\n',$val1);
my $b;
foreach my $a (@tmp1) {
    chomp($a);
...
if (-e "/usr/local/McAfee") {
    `cp /Volumes/Data/ssm_perf/Reports/app_launch_mod_rep /Volumes/Data/ssm_perf/Reports/app_launch_msc`;
}
if (-e "/usr/local/vscanx") {
    `cp /Volumes/Data/ssm_perf/Reports/app_launch_mod_rep /Volumes/Data/ssm_perf/Reports/app_launch_vsmac`;
}
if ( ! -e "/usr/local/McAfee" && ! -e "/usr/local/vscanx") {
    `cp /Volumes/Data/ssm_perf/Reports/app_launch_mod_rep /Volumes/Data/ssm_perf/Reports/app_launch`;
}
