...
class TestCase(BaseTest):
    ...
    def __init__(self):
        logging.info("TestcaseID : testFirewallUTDemo")
        logging.info("Demo UT for Firewall")
    ...
    def init(self, testZipPath):
        ...
        # After zip file extraction, check for testFirewallUTDemo binary...
