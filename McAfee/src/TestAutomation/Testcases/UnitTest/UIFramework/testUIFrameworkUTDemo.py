...
# TestcaseID: testUIFrameworkUTDemo
...
class TestCase(BaseTest):
    ...
    def __init__(self):
        logging.info("TestcaseID : testUIFrameworkUTDemo")
        logging.info("Demo UT for UIFramework")
    ...
    def init(self, testZipPath):
        ...
        # After zip file extraction, check for testUIFrameworkUTDemo binary...
