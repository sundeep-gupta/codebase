...
class TestCase(BaseTest):
    ...
    def __init__(self):
        logging.info("TestcaseID : testFMPUTDemo")
        logging.info("Demo UT for FMP")
    ...
    def init(self, testZipPath):
        ...
        # After zip file extraction, check for testFMPUTDemo binary...
        #if os.path.exists(self._testBinaryFilePath):
        #    logging.info("testLogger binary found locally for execution")
        #else:
        #    logging.error("testLogger binary not found locally for execution")
        #    return 1
