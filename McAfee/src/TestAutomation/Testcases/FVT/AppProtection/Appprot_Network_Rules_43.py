...
# TestcaseID: 16625
# TestcaseDescription: Set Restricted Network Access for application: Scenario 43
...
class TestCase(BaseTest):
    def __init__(self):
        logging.info("TestcaseID : 16625")
        logging.info("Set Restricted Network Access for application: Scenario 43.")
    ...
    def init(self):
        ...
        self.customRule=[]
        _cr = dict()
        _cr = {"IP":self.subnetAddr,"Port":"ANY_PORT","Protocol":"3",
