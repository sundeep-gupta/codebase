...
# TestcaseID: 16622
# TestcaseDescription: Set Restricted Network Access for application: Scenario 40
...
class TestCase(BaseTest):
    def __init__(self):
        logging.info("TestcaseID : 16622")
        logging.info("Set Restricted Network Access for application: Scenario 40.")
