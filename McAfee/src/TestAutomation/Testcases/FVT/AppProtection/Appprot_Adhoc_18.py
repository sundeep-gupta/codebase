...
class TestCase(BaseTest):
    ...
    _binary_1=os.path.dirname(os.path.abspath(sys.argv[0])) + "/data/SampleApplications/UDPServer"
    _binary_2=os.path.dirname(os.path.abspath(sys.argv[0])) + "/data/SampleApplications/UDPClient"
