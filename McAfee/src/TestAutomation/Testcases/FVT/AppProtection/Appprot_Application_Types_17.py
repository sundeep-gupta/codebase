...
# TestcaseID: 16419
# TestcaseDescription: "Verify adding a rule for CFM (Code Fragment binaries)" 
...
class TestCase(BaseTest):
    def __init__(self):
        logging.info("TestcaseID : 16419")
        logging.info("Description : Verify adding a rule for CFM (Code Fragment binaries)")
