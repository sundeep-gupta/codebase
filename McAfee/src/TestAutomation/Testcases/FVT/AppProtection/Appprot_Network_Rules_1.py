...
# TestcaseID: 16583
# TestcaseDescription: Set Restricted Network Access for application: Scenario 1
...
class TestCase(BaseTest):
    def __init__(self):
        logging.info("TestcaseID : 16583")
        logging.info("Set Restricted Network Access for application: Scenario 1.")
