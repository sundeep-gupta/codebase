...
# TestcaseID: 16666
# TestcaseDescription: Set Restricted Network Access for application: Scenario 84
...
class TestCase(BaseTest):
    def __init__(self):
        logging.info("TestcaseID : 16666")
        logging.info("Description : Set Restricted Network Access for application: Scenario 84")
