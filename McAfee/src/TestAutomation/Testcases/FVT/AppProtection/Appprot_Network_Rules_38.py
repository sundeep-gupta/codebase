...
# TestcaseID: 16620
# TestcaseDescription: Set Restricted Network Access for application: Scenario 38
...
class TestCase(BaseTest):
    def __init__(self):
        logging.info("TestcaseID : 16620")
        logging.info("Set Restricted Network Access for application: Scenario 38.")
