...
# TestcaseID: 16669
# TestcaseDescription: Set Restricted Network Access for application: Scenario 87
...
class TestCase(BaseTest):
    def __init__(self):
        logging.info("TestcaseID : 16669")
        logging.info("Description : Set Restricted Network Access for application: Scenario 87")
