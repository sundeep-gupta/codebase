...
# TestcaseID: 16436
# TestcaseDescription: Testcase to check the last launch results - Strict for Whitelisted application 
...
class TestCase(BaseTest):
    def __init__(self):
        logging.info("TestcaseID : 16436")
        logging.info("Description : Testcase to check the last launch results - Strict for Whitelisted application") 
