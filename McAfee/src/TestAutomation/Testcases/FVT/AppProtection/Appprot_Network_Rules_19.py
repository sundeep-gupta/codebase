...
# TestcaseID: 16601
# TestcaseDescription: Set Restricted Network Access for application: Scenario 19
...
class TestCase(BaseTest):
    def __init__(self):
        logging.info("TestcaseID : 16601")
        logging.info("Set Restricted Network Access for application: Scenario 19.")
