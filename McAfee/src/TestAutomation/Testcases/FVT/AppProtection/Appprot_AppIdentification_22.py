...
class TestCase(BaseTest):
    ...
    _depLib1 = os.path.dirname(os.path.abspath(sys.argv[0])) + "/data/SampleApplications/libSample1.dylib"
    _depLib2 = os.path.dirname(os.path.abspath(sys.argv[0])) + "/data/SampleApplications/libSample2.dylib"
