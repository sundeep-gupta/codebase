...
# TestcaseID: 16494
# TestcaseDescription:  Verify that rule can be added for an Application  located in the non-english partition or folder
...
class TestCase(BaseTest):
    def __init__(self):
        logging.info("TestcaseID : 16494")
        logging.info("Description : Verify that rule can be added for an Application  located in the non-english partition or folder")
    ...
    def execute(self):
        ...
        # Step 1 : Create a folder with non english in the name
        try:
