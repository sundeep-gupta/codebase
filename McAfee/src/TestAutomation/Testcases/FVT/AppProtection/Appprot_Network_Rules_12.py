...
# TestcaseID: 16594
# TestcaseDescription: Set Restricted Network Access for application: Scenario 12
...
class TestCase(BaseTest):
    def __init__(self):
        logging.info("TestcaseID : 16591")
        logging.info("Set Restricted Network Access for application: Scenario 12.")
    ...
    def verify(self):
        ...
        #needs to verify AppProt trace file for rule match
            ...
            return 0
        logging.info("Sending UDP Data Failed as expected")
        return 0
