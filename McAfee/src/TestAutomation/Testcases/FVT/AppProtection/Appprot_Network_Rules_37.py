...
# TestcaseID: 16619
# TestcaseDescription: Set Restricted Network Access for application: Scenario 37
...
class TestCase(BaseTest):
    def __init__(self):
        logging.info("TestcaseID : 16619")
        logging.info("Set Restricted Network Access for application: Scenario 37.")
