...
# TestcaseID: 16499
# TestcaseDescription: Verify that App Pro kext is not unloaded when App Pro is disabled
...
class TestCase(BaseTest):
    def __init__(self):
        logging.info("TestcaseID : 16499")
        logging.info("Description : Verify that App Pro kext is not unloaded when App Pro is disabled")
    ...
    def execute(self):
        ...
        if CommonAppProFns.disableAppProt() == False:
            logging.error("Unable to disable application protection")
            return 1
        logging.info("disabled app protection")
        return 0
