...
# TestcaseID: 16503
# TestcaseDescription:  Verify that Verify application honors  exclusion for an application whose name length is as long as allowed by the OS
...
class TestCase(BaseTest):
    def __init__(self):
        logging.info("TestcaseID : 16503")
        logging.info("Description : Verify that Verify application honors  exclusion for an application whose name length is as long as allowed by the OS")
