...
# TestcaseID: 16654
# TestcaseDescription: Set Restricted Network Access for application: Scenario 72
...
class TestCase(BaseTest):
    def __init__(self):
        logging.info("TestcaseID : 16654")
        logging.info("Description : Set Restricted Network Access for application: Scenario 72")
