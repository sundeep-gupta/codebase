...
# TestcaseID: 16437
# TestcaseDescription: Testcase to check the last launch results - Strict for modified Whitelisted application 
...
class TestCase(BaseTest):
    def __init__(self):
        logging.info("TestcaseID : 16437")
        logging.info("Description : Testcase to check the last launch results - Strict for modified Whitelisted application") 
