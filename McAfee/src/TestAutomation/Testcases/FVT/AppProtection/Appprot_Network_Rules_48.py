    ...
    def verify(self):
        ...
        try :
            ...
            if commonFns.parseFile("/usr/local/McAfee/AppProtection/var/appProt.trace",_regex) != True:
                logging.error("UDP connection not denied for the given IP address")
                return 1
        ...
        logging.info("Restricted Network Rule for subnet working as expected")
        return 0
