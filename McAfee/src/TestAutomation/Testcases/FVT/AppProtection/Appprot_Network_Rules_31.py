...
# TestcaseID: 16613
# TestcaseDescription: Set Restricted Network Access for application: Scenario 31
...
class TestCase(BaseTest):
    def __init__(self):
        logging.info("TestcaseID : 16613")
        logging.info("Set Restricted Network Access for application: Scenario 31.")
