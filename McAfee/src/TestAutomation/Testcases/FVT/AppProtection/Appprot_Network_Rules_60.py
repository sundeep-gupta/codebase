...
# TestcaseID: 16642
# TestcaseDescription: Set Restricted Network Access for application: Scenario 60
...
class TestCase(BaseTest):
    def __init__(self):
        logging.info("TestcaseID : 16642")
        logging.info("Set Restricted Network Access for application: Scenario 60.")
    ...
    def verify(self):
        ...
        try :
            ...
            _regex="Denied "+self.app_path_server+" from accepting a UDP connection from "+self.hostIp
            if commonFns.parseFile("/usr/local/McAfee/AppProtection/var/appProt.trace",_regex) != True:
                logging.error("UDP connection accepted for the given IP address")
                return 1
