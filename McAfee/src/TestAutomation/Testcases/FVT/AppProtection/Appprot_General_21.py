...
# TestcaseID: 16493
# TestcaseDescription:  Verify that rule can be added for an Application  containing spl characters in the App name
...
class TestCase(BaseTest):
    def __init__(self):
        logging.info("TestcaseID : 16493")
        logging.info("Description : Verify that rule can be added for an Application  containing spl characters in the App name")
    ...
    def execute(self):
        ...
        # Step 1 : Create a folder with spl characters in the name
        try:
