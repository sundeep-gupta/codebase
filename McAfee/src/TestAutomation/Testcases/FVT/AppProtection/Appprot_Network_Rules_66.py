...
# TestcaseID: 16648
# TestcaseDescription: Set Restricted Network Access for application: Scenario 66
...
class TestCase(BaseTest):
    def __init__(self):
        logging.info("TestcaseID : 16648")
        logging.info("Description : Set Restricted Network Access for application: Scenario 66")
    ...
    def execute(self):
        ...
        try :
            logging.debug("Checking the allow with port %s for TCP" % self.server_port_1)
    ...
    def verify(self):
        ...
        time.sleep(10)
        # UDP Should be denied as per rule.
        logging.debug("Checking UDP Deny : %s" % self.regex_deny_udp)
        ...
        # TCP Should be allowed as per rule.
