...
class TestCase(BaseTest):
    ...
    _curLocLib1 = os.path.dirname(os.path.abspath(sys.argv[0])) + "/data/SampleApplications/libSample1.dylib"
    _curLocLib2 = os.path.dirname(os.path.abspath(sys.argv[0])) + "/data/SampleApplications/libSample2.dylib"
