...
# TestcaseID: 16652
# TestcaseDescription: Set Restricted Network Access for application: Scenario 70
...
class TestCase(BaseTest):
    def __init__(self):
        logging.info("TestcaseID : 16652")
        logging.info("Description : Set Restricted Network Access for application: Scenario 70")
