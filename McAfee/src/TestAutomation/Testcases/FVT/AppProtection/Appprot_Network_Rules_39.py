...
# TestcaseID: 16621
# TestcaseDescription: Set Restricted Network Access for application: Scenario 39
...
class TestCase(BaseTest):
    def __init__(self):
        logging.info("TestcaseID : 16621")
        logging.info("Set Restricted Network Access for application: Scenario 39.")
    ...
    def init(self):
        ...
        self.customRule=[]
        _cr = dict()
        _cr = {"IP":self.hostIp,"Port":"ANY_PORT","Protocol":"2",
