...
class TestCase(BaseTest):
    ...
    def execute(self):
        ...
        self._rule1 = dict()
        self._rule1["AppPath"]= os.path.dirname(os.path.abspath(sys.argv[0])) + "/data/SampleApplications/UDPServer"
        ...
        self._rule2 = dict()
        self._rule2["AppPath"]= os.path.dirname(os.path.abspath(sys.argv[0])) + "/data/SampleApplications/UDPClient"
        ...
        try:
            self._process1 =subprocess.Popen( [ os.path.dirname(os.path.abspath(sys.argv[0])) + "/data/SampleApplications/UDPServer" ],
        ...
        try:
            self._process2 =subprocess.Popen( [ os.path.dirname(os.path.abspath(sys.argv[0])) + "/data/SampleApplications/UDPClient" ],
                                         stdout=subprocess.PIPE,
                                         stderr=subprocess.PIPE)
