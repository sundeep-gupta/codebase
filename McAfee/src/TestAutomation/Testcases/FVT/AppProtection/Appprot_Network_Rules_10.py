...
# TestcaseID: 16592
# TestcaseDescription: Set Restricted Network Access for application: Scenario 10
...
class TestCase(BaseTest):
    def __init__(self):
        logging.info("TestcaseID : 16592")
        logging.info("Set Restricted Network Access for application: Scenario 10.")
    ...
    def verify(self):
        ...
        try :
            ...
            return 0
        logging.info("connection Failed to TCPServer as expected ")
        return 0
