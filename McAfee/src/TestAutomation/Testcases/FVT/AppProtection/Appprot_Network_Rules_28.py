...
# TestcaseID: 16610
# TestcaseDescription: Set Restricted Network Access for application: Scenario 28
...
class TestCase(BaseTest):
    def __init__(self):
        logging.info("TestcaseID : 16610")
        logging.info("Set Restricted Network Access for application: Scenario 28.")
