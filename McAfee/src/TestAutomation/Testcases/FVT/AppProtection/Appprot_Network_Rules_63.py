...
# TestcaseID: 16645
# TestcaseDescription: Set Restricted Network Access for application: Scenario 63
...
class TestCase(BaseTest):
    def __init__(self):
        logging.info("TestcaseID : 16645")
        logging.info("Description : Set Restricted Network Access for application: Scenario 63")
