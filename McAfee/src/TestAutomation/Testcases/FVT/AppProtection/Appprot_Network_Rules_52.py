...
# TestcaseID: 16634
# TestcaseDescription: Set Restricted Network Access for application: Scenario 52
...
class TestCase(BaseTest):
    def __init__(self):
        logging.info("TestcaseID : 16634")
        logging.info("Set Restricted Network Access for application: Scenario 52.")
    ...
    def verify(self):
        ...
        try :
            ...
            subprocess.call([self.app_path_client, self.hostIp, self.port,"Message"],\
                            ...
                            stderr=subprocess.PIPE)
            time.sleep(10)
            _regex="Denied "+self.app_path_server+" from accepting a TCP connection from "+self.hostIp+":"+self.port
        ...
        logging.info("Restricted Network Rule  for subnet and Port  working as expected")
        return 0
