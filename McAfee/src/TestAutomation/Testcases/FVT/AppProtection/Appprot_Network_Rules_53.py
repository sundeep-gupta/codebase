...
# TestcaseID: 16635
# TestcaseDescription: Set Restricted Network Access for application: Scenario 53
...
class TestCase(BaseTest):
    def __init__(self):
        logging.info("TestcaseID : 16635")
        logging.info("Set Restricted Network Access for application: Scenario 53.")
