...
def performTest() :
    ...
    _tmpLogFilePtr.write("===DESC:Running FMP UT for build : " + _buildNum + "\n")

    print " ====== Running FMP UT for build : " + _buildNum + " ========" 
    sys.stdout.flush()
    ...
    while _iterCnt != _runCntMax :
        ...
        try:
            ...
            _testURL = "http://192.168.215.135/Builds/TOPS/FMP/" + _buildNum + "/FMP-UT-" + _buildNum + ".tar.gz"
            _testSuiteName = 'FMP-UT'
            ...
            if _retVal != 0 :
                print "Test for FMP UT returned %d." % (_retVal)
                _iterCnt = _iterCnt + 1
                time.sleep(5)
                continue
        ...
        _outputZipFile = "FMP-UT-" + _buildNum + "-logs.zip"
