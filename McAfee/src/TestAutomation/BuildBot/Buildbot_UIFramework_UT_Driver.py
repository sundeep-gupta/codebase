...
def performTest() :
    ...
    _tmpLogFilePtr.write("===DESC:Running UIFramework UT for build : " + _buildNum + "\n")

    print " ====== Running UIFramework UT for build : " + _buildNum + " ========" 
    sys.stdout.flush()
    ...
    while _iterCnt != _runCntMax :
        ...
        try:
            ...
            _testURL = "http://192.168.215.135/Builds/TOPS/UIFRAMEWORK/" + _buildNum + "/UIFramework-UT-" + _buildNum + ".tar.gz"
            _testSuiteName = 'UIFramework-UT'
            ...
            if _retVal != 0 :
                print "Test for UIFramework UT returned %d." % (_retVal)
                _iterCnt = _iterCnt + 1
                time.sleep(5)
                continue
        ...
        _outputZipFile = "UIFramework-UT-" + _buildNum + "-logs.zip"
