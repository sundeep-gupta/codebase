...
def performTest() :
    ...
    _tmpLogFilePtr.write("===DESC:Running Firewall UT for build : " + _buildNum + "\n")

    print " ====== Running Firewall UT for build : " + _buildNum + " ========" 
    sys.stdout.flush()
    ...
    while _iterCnt != _runCntMax :
        ...
        try:
            ...
            _testURL = "http://192.168.215.135/Builds/TOPS/FIREWALL/" + _buildNum + "/Firewall-UT-" + _buildNum + ".tar.gz"
            _testSuiteName = 'Firewall-UT'
            ...
            if _retVal != 0 :
                print "Test for Firewall UT returned %d." % (_retVal)
                _iterCnt = _iterCnt + 1
                time.sleep(5)
                continue
        ...
        _outputZipFile = "Firewall-UT-" + _buildNum + "-logs.zip"
