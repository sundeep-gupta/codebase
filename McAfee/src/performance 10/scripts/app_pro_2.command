...
my $log_file = "$root_path/Reports/app_pro.log";
my $file_size;
...
#system ("rm -rf $root_path/Reports/apppro.log") if (-e "$root_path/Reports/apppro.log");
system ("rm -rf $root_path/$download_file") if (-e "$root_path/$download_file");

my $part_file = "$root_path/$download_file" . "\.part";
my $d_file = "$root_path/$download_file";
my $down_file = "$root_path/$download_file" . "\.download";
