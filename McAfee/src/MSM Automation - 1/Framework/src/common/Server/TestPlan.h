...
public:
	...
	*/
	...
	/** \brief Method to get plan required directory.
	 */
	string getPlanRequiredDir() const
	{
		return m_planRequiredDir;
	}
...
private:
	...
	*/
	...
	/** \brief Plan required directory for testcase execution. */
	string m_planRequiredDir;
};
