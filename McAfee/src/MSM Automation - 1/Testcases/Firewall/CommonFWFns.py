...
FWTT_PATH = os.path.dirname(os.path.abspath(sys.argv[0])) + "/../Firewall/data/fwtt/FWTestTool"
...
def deleteFWRule(ruleName):
    ...
    if ruleId == None:
        return False
    subprocess.call( [  FWTT_PATH, "4", ruleId ],stdout=subprocess.PIPE,stderr=subprocess.PIPE)
...
def enableCustomRules():
    ...
    """
    subprocess.call( [ FWTT_PATH, str(5), str(0),str(0),str(0),str(4)],stdout=subprocess.PIPE,stderr=subprocess.PIPE)
    return True
