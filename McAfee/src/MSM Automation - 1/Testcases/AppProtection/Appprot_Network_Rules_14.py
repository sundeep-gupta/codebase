...
# TestcaseID: 16596
# TestcaseDescription: Set Restricted Network Access for application: Scenario 14
...
class TestCase(BaseTest):
    def __init__(self):
        logging.info("TestcaseID : 16596")
        logging.info("Set Restricted Network Access for application: Scenario 14.")
