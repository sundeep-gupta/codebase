...
# TestcaseID: 16636
# TestcaseDescription: Set Restricted Network Access for application: Scenario 54
...
class TestCase(BaseTest):
    def __init__(self):
        logging.info("TestcaseID : 16636")
        logging.info("Set Restricted Network Access for application: Scenario 54.")
