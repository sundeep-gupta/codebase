...
# TestcaseID: 16656
# TestcaseDescription: Set Restricted Network Access for application: Scenario 74
...
class TestCase(BaseTest):
    def __init__(self):
        logging.info("TestcaseID : 16656")
        logging.info("Description : Set Restricted Network Access for application: Scenario 74")
