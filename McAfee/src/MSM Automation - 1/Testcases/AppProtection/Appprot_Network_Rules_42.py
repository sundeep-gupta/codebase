...
# TestcaseID: 16624
# TestcaseDescription: Set Restricted Network Access for application: Scenario 42
...
class TestCase(BaseTest):
    def __init__(self):
        logging.info("TestcaseID : 16624")
        logging.info("Set Restricted Network Access for application: Scenario 42.")
