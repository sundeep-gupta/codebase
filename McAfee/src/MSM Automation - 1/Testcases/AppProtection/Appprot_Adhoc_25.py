...
# TestcaseID: 17449 
# TestcaseDescription: AppPro rule test when AppPro feature is turned OFF and ON 
...
class TestCase(BaseTest):
    def __init__(self):
        logging.info("TestcaseID : 17449")
        logging.info("Description : AppPro rule test when AppPro feature is turned OFF and ON ")
	...
	logging.info("Initializing testcase %s" % testcaseName)
        ...
        if _retval != 0:
            return 1
	self.app_paths = "/Applications/Firefox.app"
	...
	logging.info("Executing testcase %s" % testcaseName)
        ...
        if CommonAppProFns.disableAppProt()!=True:
            logging.error("Failed to Disable")
            return 1
        ...
        if CommonAppProFns.enableAppProt()!=True:
            logging.error("Failed to enable")
            return 1
	...
	logging.info("Verifying testcase %s" % testcaseName)
        ...
        logging.info("Verify: rules are equal")
	return 0
