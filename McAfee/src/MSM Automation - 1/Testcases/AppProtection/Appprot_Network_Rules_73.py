...
# TestcaseID: 16655
# TestcaseDescription: Set Restricted Network Access for application: Scenario 73
...
class TestCase(BaseTest):
    def __init__(self):
        logging.info("TestcaseID : 16655")
        logging.info("Description : Set Restricted Network Access for application: Scenario 73")
