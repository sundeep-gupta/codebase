...
# TestcaseID: 16632
# TestcaseDescription: Set Restricted Network Access for application: Scenario 50
...
class TestCase(BaseTest):
    def __init__(self):
        logging.info("TestcaseID : 16632")
        logging.info("Set Restricted Network Access for application: Scenario 50.")
    ...
    def verify(self):
        ...
        try :
            ...
            _regex="Granted permission to "+self.app_path_server+" for  accepting a TCP connection from "+self.hostIp+":"+self.port
        ...
        logging.info("Restricted Network Rule working for Subnetaddr and Port as expected")
        return 0
