...
# TestcaseID: 16637
# TestcaseDescription: Set Restricted Network Access for application: Scenario 55
...
class TestCase(BaseTest):
    def __init__(self):
        logging.info("TestcaseID : 16637")
        logging.info("Set Restricted Network Access for application: Scenario 55.")
