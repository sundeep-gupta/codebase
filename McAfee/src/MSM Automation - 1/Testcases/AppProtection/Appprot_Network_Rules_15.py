...
# TestcaseID: 16597
# TestcaseDescription: Set Restricted Network Access for application: Scenario 15
...
class TestCase(BaseTest):
    def __init__(self):
        logging.info("TestcaseID : 16597")
        logging.info("Set Restricted Network Access for application: Scenario 15.")
    ...
    def verify(self):
        ...
        #needs to verify AppProt trace file for rule match
            ...
            return 1
        logging.info("Subnet Rule is Matched & App got Launched and UDP Data Sent")
        return 0
