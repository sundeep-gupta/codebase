...
# TestcaseID: 16662
# TestcaseDescription: Set Restricted Network Access for application: Scenario 80
...
class TestCase(BaseTest):
    def __init__(self):
        logging.info("TestcaseID : 16662")
        logging.info("Description : Set Restricted Network Access for application: Scenario 80")
