...
# TestcaseID: 16644
# TestcaseDescription: Set Restricted Network Access for application: Scenario 62
...
class TestCase(BaseTest):
    def __init__(self):
        logging.info("TestcaseID : 16644")
        logging.info("Description : Set Restricted Network Access for application: Scenario 62")
    ...
    def verify(self):
        ...
        logging.debug("Checking for outgoing allow for TCP : %s" % self.regex_allow_tcp)
    ...
    def _init_variables(self):
        ...
        self.rule     = {
                ...
                "NwAction"    : "3",
                "CustomRules" : [
                     # Add rule to allow outgoing TCP connection
                     {
                        'IP'       : "ANY_IP",
                        'Port'     : "ANY_PORT",
                        'Protocol' : '1', # TCP
