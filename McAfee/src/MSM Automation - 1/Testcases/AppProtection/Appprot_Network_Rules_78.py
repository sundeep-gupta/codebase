...
# TestcaseID: 16660
# TestcaseDescription: Set Restricted Network Access for application: Scenario 78
...
class TestCase(BaseTest):
    def __init__(self):
        logging.info("TestcaseID : 16660")
        logging.info("Description : Set Restricted Network Access for application: Scenario 78")
