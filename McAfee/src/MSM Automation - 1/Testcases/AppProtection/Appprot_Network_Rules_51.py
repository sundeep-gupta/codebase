...
# TestcaseID: 16633
# TestcaseDescription: Set Restricted Network Access for application: Scenario 51
...
class TestCase(BaseTest):
    def __init__(self):
        logging.info("TestcaseID : 16633")
        logging.info("Set Restricted Network Access for application: Scenario 51.")
    ...
    def init(self):
        ...
        self.customRule=[]
        _cr = dict()
        _cr = {"IP":self.subnetAddr,"Port":self.port,"Protocol":"2",
    ...
    def verify(self):
        ...
        try :
            ...
            _regex="Granted permission to "+self.app_path_server+" for  accepting a UDP connection from "+self.hostIp+":"+self.port
        ...
        logging.info("Restricted Network Rule working  for Subnet and Port as expected")
        return 0
