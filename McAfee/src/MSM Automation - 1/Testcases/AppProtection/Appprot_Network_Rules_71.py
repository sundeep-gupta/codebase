...
# TestcaseID: 16653
# TestcaseDescription: Set Restricted Network Access for application: Scenario 71
...
class TestCase(BaseTest):
    def __init__(self):
        logging.info("TestcaseID : 16653")
        logging.info("Description : Set Restricted Network Access for application: Scenario 71")
