...
# TestcaseID: 16614
# TestcaseDescription: Set Restricted Network Access for application: Scenario 32
...
class TestCase(BaseTest):
    def __init__(self):
        logging.info("TestcaseID : 16614")
        logging.info("Set Restricted Network Access for application: Scenario 32.")
    ...
    def verify(self):
        ...
        try :
            _p = subprocess.call([self.app_path_client,"TCP","127.0.0.1","5000","Message"], stdout=subprocess.PIPE)
            if _p == 0 :
                _regex="Granted permission to "+self.app_path_server+" for  accepting a TCP connection from 127.0.0.1:5000"
                time.sleep(10)
            ...
            return 1
        logging.info("TCP Connection established and data been sent")
        return 0
