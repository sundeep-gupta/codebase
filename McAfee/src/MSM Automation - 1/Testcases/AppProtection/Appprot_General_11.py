...
# TestcaseID: 16483
# TestcaseDescription:  Testcase to check the registeration with FMP
...
class TestCase(BaseTest):
    def __init__(self):
        logging.info("TestcaseID : 16483")
        logging.info("Description : Testcase to check the registeration with FMP")
    ...
    def execute(self):
        ...
        # Step 3 Restart App Protection
        subprocess.call(["/usr/local/McAfee/AppProtection/bin/AppProtControl","restart"],stdout=subprocess.PIPE,stderr=subprocess.PIPE)
        time.sleep(20)
        return 0
