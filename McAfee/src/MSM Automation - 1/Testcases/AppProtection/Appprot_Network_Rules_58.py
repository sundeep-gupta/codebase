...
# TestcaseID: 16640
# TestcaseDescription: Set Restricted Network Access for application: Scenario 58
...
class TestCase(BaseTest):
    def __init__(self):
        logging.info("TestcaseID : 16640")
        logging.info("Description : Set Restricted Network Access for application: Scenario 58")
    ...
    def verify(self):
        ...
        # Check if connection is DENIED in given port range
        logging.debug("Checking incoming allow connection: %s" % self.regex_deny_tcp)
        ...
        # Check if Connection is ALLOWED out of the range specified in rule.
        logging.debug("Checking incoming deny connection : %s" % self.regex_allow_tcp)
    ...
    def _start_tcp_server(self):
        # Start TCP server and BIND to port within DENY RANGE
        ...
        # Start TCP Server and BIND to port in ALLOW RANGE
