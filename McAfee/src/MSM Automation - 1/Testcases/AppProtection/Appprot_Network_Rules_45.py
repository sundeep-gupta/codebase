...
# TestcaseID: 16627
# TestcaseDescription: Set Restricted Network Access for application: Scenario 45
...
class TestCase(BaseTest):
    def __init__(self):
        logging.info("TestcaseID : 16627")
        logging.info("Set Restricted Network Access for application: Scenario 45.")
    ...
    def init(self):
        ...
        self.customRule=[]
        _cr = dict()
        _cr = {"IP":self.subnetAddr,"Port":"ANY_PORT","Protocol":"2",
