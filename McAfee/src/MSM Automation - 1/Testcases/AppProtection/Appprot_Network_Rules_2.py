...
# TestcaseID: 16584
# TestcaseDescription: Set Restricted Network Access for application: Scenario 2
...
class TestCase(BaseTest):
    def __init__(self):
        logging.info("TestcaseID : 16584")
        logging.info("Set Restricted Network Access for application: Scenario 2.")
    ...
    def verify(self):
        ...
        try :
            ...
            if _p == 0 :
                time.sleep(10)
                _regex="Granted permission to "+self.app_path_client+" for  creating a TCP connection to 127.0.0.1:5000"
