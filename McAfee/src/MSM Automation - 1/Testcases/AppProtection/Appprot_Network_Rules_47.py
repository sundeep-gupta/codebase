...
# TestcaseID: 16629
# TestcaseDescription: Set Restricted Network Access for application: Scenario 47
...
class TestCase(BaseTest):
    def __init__(self):
        logging.info("TestcaseID : 16629")
        logging.info("Set Restricted Network Access for application: Scenario 47.")
