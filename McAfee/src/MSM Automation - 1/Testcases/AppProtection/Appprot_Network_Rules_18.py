...
# TestcaseID: 165600
# TestcaseDescription: Set Restricted Network Access for application: Scenario 18
...
class TestCase(BaseTest):
    def __init__(self):
        logging.info("TestcaseID : 16600")
        logging.info("Set Restricted Network Access for application: Scenario 18.")
    ...
    def verify(self):
        ...
        #needs to verify AppProt trace file for rule match
            ...
            return 0
        logging.info("Sending UDP Data Failed as expected due to Subnet Rule Match")
        return 0
