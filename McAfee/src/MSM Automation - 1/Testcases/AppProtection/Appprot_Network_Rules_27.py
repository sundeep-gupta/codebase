...
# TestcaseID: 16609
# TestcaseDescription: Set Restricted Network Access for application: Scenario 27
...
class TestCase(BaseTest):
    def __init__(self):
        logging.info("TestcaseID : 16609")
        logging.info("Set Restricted Network Access for application: Scenario 27.")
