...
# TestcaseID: 16585
# TestcaseDescription: Set Restricted Network Access for application: Scenario 3 
...
class TestCase(BaseTest):
    def __init__(self):
        logging.info("TestcaseID : 16585")
        logging.info("Set Restricted Network Access for application: Scenario 3.")
    ...
    def verify(self):
        ...
        try :
            ...
            _regex="Granted permission to "+self.app_path+" for  creating a UDP connection to 127.0.0.1:5000"
            ...
            return 1
        logging.info("Application got launced Data has been sent")
        return 0
