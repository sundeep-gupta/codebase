...
# TestcaseID: 16586
# TestcaseDescription: Set Restricted Network Access for application: Scenario 6
    ...
    def verify(self):
        ...
        try :
            ...
            if commonFns.parseFile("/usr/local/McAfee/AppProtection/var/appProt.trace",_regex) != True:
                ...
                return 1
        #needs to check AppPro trace log for matching state ment
        except:
            logging.debug("Failed to launch application  ")
            return 1
        logging.info("Regex Match Found and UDP sending data failed")
        return 0
