...
# TestcaseID: 16617
# TestcaseDescription: Set Restricted Network Access for application: Scenario 36
...
class TestCase(BaseTest):
    def __init__(self):
        logging.info("TestcaseID : 16617")
        logging.info("Set Restricted Network Access for application: Scenario 36.")
    ...
    def verify(self):
        ...
        try :
            ...
            if _p == 0 :
                _regex="Denied "+self.app_path_server+" from accepting a UDP connection from 127.0.0.1:5000"
                time.sleep(10)
            ...
            return 1
        logging.info("UDP Connection Failed Data not been sent")
        return 0
