...
# TestcaseID: 16595
# TestcaseDescription: Set Restricted Network Access for application: Scenario 13
...
class TestCase(BaseTest):
    def __init__(self):
        logging.info("TestcaseID : 16595")
        logging.info("Set Restricted Network Access for application: Scenario 13.")
    ...
    def verify(self):
        ...
        #needs to verify AppProt trace file for rule match
            ...
            return 1
        logging.info("App got Launched and UDP data allowed for Subnet")
        return 0
