...
# TestcaseID: 16590
# TestcaseDescription: Set Restricted Network Access for application: Scenario 8
...
class TestCase(BaseTest):
    def __init__(self):
        logging.info("TestcaseID : 16590")
        logging.info("Set Restricted Network Access for application: Scenario 8.")
    ...
    def verify(self):
        ...
        try :
            process=subprocess.call([self.app_path_client,self.hostIp,"5000","Message"], stdout=subprocess.PIPE)
            if process!=0:
        ...
        logging.info("connected to TCPServer and data been sent ")
        return 0
