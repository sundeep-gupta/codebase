...
# TestcaseID: 17436
# TestcaseDescription:  Application execution when hard link is created and app added to AppPro exclusion list
...
class TestCase(BaseTest):
    _binaryPath = os.getcwd() + "/data/SampleApplications/UDPClient" 
    def __init__(self):
        logging.info("TestcaseID : 17436")
        logging.info("Description : Application execution when hard link is created and app added to AppPro exclusion list")
    ...
    def execute(self):
        ...
        if CommonAppProFns.setAppProExclusions( [ os.getcwd() + "/data/aptt",self._binaryPath ]) != True:
