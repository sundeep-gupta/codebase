...
# TestcaseID: 16591
# TestcaseDescription: Set Restricted Network Access for application: Scenario 9
...
class TestCase(BaseTest):
    def __init__(self):
        ...
        logging.info("Set Restricted Network Access for application: Scenario 9.")
    ...
    def verify(self):
        ...
        #needs to verify AppProt trace file for rule match
            ...
            return 1
        logging.info("App got Launched and UDP Data Sent")
        return 0
