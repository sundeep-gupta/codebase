...
# TestcaseID: 16631
# TestcaseDescription: Set Restricted Network Access for application: Scenario 49
...
class TestCase(BaseTest):
    def __init__(self):
        logging.info("TestcaseID : 16631")
        logging.info("Set Restricted Network Access for application: Scenario 49.")
