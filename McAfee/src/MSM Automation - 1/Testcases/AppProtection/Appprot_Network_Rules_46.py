...
# TestcaseID: 16628
# TestcaseDescription: Set Restricted Network Access for application: Scenario 46
...
class TestCase(BaseTest):
    def __init__(self):
        logging.info("TestcaseID : 16628")
        logging.info("Set Restricted Network Access for application: Scenario 46.")
