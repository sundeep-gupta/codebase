...
# TestcaseID: 16626
# TestcaseDescription: Set Restricted Network Access for application: Scenario 44
...
class TestCase(BaseTest):
    def __init__(self):
        logging.info("TestcaseID : 16626")
        logging.info("Set Restricted Network Access for application: Scenario 44.")
    ...
    def init(self):
        ...
        self.customRule=[]
        _cr = dict()
        _cr = {"IP":self.subnetAddr,"Port":"ANY_PORT","Protocol":"1",
