...
# TestcaseID: 16606
# TestcaseDescription: Set Restricted Network Access for application: Scenario 24
...
class TestCase(BaseTest):
    def __init__(self):
        logging.info("TestcaseID : 16606")
        logging.info("Set Restricted Network Access for application: Scenario 24.")
