...
# TestcaseID: 16650
# TestcaseDescription: Set Restricted Network Access for application: Scenario 68
...
class TestCase(BaseTest):
    def __init__(self):
        logging.info("TestcaseID : 16650")
        logging.info("Description : Set Restricted Network Access for application: Scenario 68")
