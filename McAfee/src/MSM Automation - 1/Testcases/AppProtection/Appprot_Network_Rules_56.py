...
# TestcaseID: 16638
# TestcaseDescription: Set Restricted Network Access for application: Scenario 56
...
class TestCase(BaseTest):
    def __init__(self):
        logging.info("TestcaseID : 16638")
        logging.info("Set Restricted Network Access for application: Scenario 56.")
    ...
    def verify(self):
        ...
        try :
            ...
            _regex="Granted permission to "+self.app_path_server+" for  accepting a TCP connection from "+self.hostIp
            if commonFns.parseFile("/usr/local/McAfee/AppProtection/var/appProt.trace",_regex) != True:
                logging.error("TCP connection not accepted for the given IP address")
                return 1
