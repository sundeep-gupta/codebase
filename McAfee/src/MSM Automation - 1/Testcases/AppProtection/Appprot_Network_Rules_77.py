...
# TestcaseID: 16659
# TestcaseDescription: Set Restricted Network Access for application: Scenario 77
...
class TestCase(BaseTest):
    def __init__(self):
        logging.info("TestcaseID : 16659")
        logging.info("Description : Set Restricted Network Access for application: Scenario 77")
