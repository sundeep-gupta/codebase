...
package Conf::Mac::Consumer::Performance;
...
my $TEST_CONFIG = {
    ...
    'test_case_list'    => [
        ...
        {
            'name' => 'Applaunch',   'execute' => 1,
            'tc_desc' => 'McAfee Internet Security launch ',
	    'runs_per_iteration' => 1,
            'applications' => [ 'McAfee Internet Security' ],
        },
        ...
        { 
            ...
            'tc_desc' => 'On-access scan with infected data',
            'runs_per_iteration' => 1,
            'data_dir'           => 'oas-mixed',
            'write' => {
                'file_count'         => 10,
        ...
        },
        {
            ...
            'tc_desc' => 'On-demand scan clean data',
            'runs_per_iteration' => 2,
            'data_dir'           => 'ods-clean',
            'capture_cpu_memory' => 1,
        },
        { 'name' => 'ODSMixed' ,   'execute'            => 0,
            'tc_desc' => 'On-demand scan infected data' ,
            'runs_per_iteration' => 1,
            'data_dir'           => 'ods-mixed',
            'capture_cpu_memory' => 1,
            'ods_action'         => 'delete',
        ...
        { 'name' => 'Install' ,     'execute'            => 0,
            'tc_desc' => 'Install McAfee Security',
            'runs_per_iteration' => 1,
            'build'              => 178,
            'capture_cpu_memory'  => 1,
            'capture_frequency'  => 5,
        ...
        { 'name' => 'Shutdown', 'execute'            => 0,
            'tc_desc' => 'Shutdown machine', 
            'runs_per_iteration' => 1,
        },

        { 'name' => 'IdleTime',    'execute'            => 0,
            'tc_desc' => 'idle time ',
            'runs_per_iteration' => 1,
            'sleep_time'         => 5,
        },
        ...
        { 'name' => 'DiskSpace', 'execute'            => 0,
            'tc_desc' => 'disk used by product',
            'runs_per_iteration' => 1,
        },
...
######################################## TEST CASE REQUIRE NETWORK ACCESS ###############################################
        { 'name' => 'Appusage',    'execute'            => 0,
            'tc_desc' => 'application usage time',
            'runs_per_iteration' => 2,
