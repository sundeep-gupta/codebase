...
{ 
  ...
  ${ROOT_PATH}/ssm_perf/scripts/Record_memory_usage.pl 3 & 
  ...
  ${ROOT_PATH}/ssm_perf/scripts/Update.sh 
...
{ 
  ...
  osascript ${ROOT_PATH}/ssm_perf/scripts/Product_Update.scpt > /dev/null 2>&1;
