...
{ 
  ...
  my $end_time; 
  my $total_time_taken; 
  my $upgradetime_log = "$ENV{ROOT_PATH}/ssm_perf/Reports/UpgradeTime.log";
...
sub install_product
{
 ...
 { 
   ...
   $out=`installer -pkg $ENV{ROOT_PATH}/ssm_perf/Builds/VSMAC/*.mpkg -target /Applications/ 2>/dev/null`;
