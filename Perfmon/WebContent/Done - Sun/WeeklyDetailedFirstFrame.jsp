...
<HTML>
<HEAD>
<TITLE>Weekly Detailed Report</TITLE>
...
history.forward(-1);
/*
	Function for displaying the weekly Reports
*/
...
/*
	Function for displaying date format in mm-dd-yyyy
*/
function weekDays(){
	var dt = new Date();
...
//	var firstDate = dt.getDate() + '-' + mon + '-' + dt.getFullYear();
	var firstDate = mon + '-' + dt.getDate() + '-' + dt.getFullYear();
	labelVal = "From Date  : " + firstDate + ' To Date : ' + lastDate;
	document.getElementById('weekDate').innerText = labelVal;
}
/*
	Function for displaying title of the Weekly Detailed Report
*/
function setTitle(){
...
%>
<BODY onLoad="javascript:weekDays(),setTitle()">
...
<table width="95%" border="0" cellpadding="0" cellspacing="0" align="center" class="tabinside">
		...
		<table width="95%" align="CENTER" border="0" cellspacing=0 cellpadding=0  height="40%">
					...
					<tr>
					<td id="weekDate" align colspan="3" class="fieldnames" height="30" width="60%">
					</td>
					</tr>
						<tr>
			...
			<td align="left" width="15%"><input type="button" value="View Report" class=button  onClick="javascript:generateWeeklyReports()"/></td>
						</tr>
