...
<%
   //Getting the http content 
    ...
    if ((contentType != null) && (contentType.indexOf("multipart/form-data") >= 0)) {
        ...
        String path         = "C:\\Program Files\\Apache Group\\Tomcat 4.1\\webapps\\Birt\\Files\\"+saveFile;
        int servidpos       = file.indexOf("ServiceId\"");
        int servidlastpos   = file.indexOf("-",servidpos);
        ...
        String strServId    = file.substring(servidpos+14,servidlastpos-2);
        int serviceid       = Integer.parseInt(strServId);
        ...
        try {
            ...
            //String SQL = "insert into monitoringspecifications(CUSTID,FREQUENCY,SDESCRIPTION,LDESCRIPTION,SCRIPT) values("+custid+","+ifrq+",'"+sdescription+"','"+ldescription+"','"+str+"')";
            String SQL="update monitoringspecifications set ldescription='"+ldescription+"',frequency="+ifrq+",script='"+str+"' where serviceid="+serviceid;
            //out.println(SQL);
...
%>
								<b>File Uploaded Successfully</b><br><b><br>				
								 ...
								 <br><br><a href="updateServSpec.jsp">Back to Update Service Specifications</a> 
