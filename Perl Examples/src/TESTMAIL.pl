...
my $to_address = 'razikh.mohamed@applabs.com';
my $mail_host = 'smtp.applabs.com';

### Adjust subject and body message
my $subject = 'Copy and paste...';
my $message_body = "<body><b>Razikh,</b><p/><p>Stop doing Web desinging.</p><p>Thanks</P><p><b>Pavan</b></p></body>";
