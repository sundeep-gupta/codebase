...
# 
# Script ID:			MCR-014
# Script Name:			MCR-014.pl
# Description:			Verifies integrity of mid-compressible-data transferred using wget http from server to client at first level of compression
...
if ($help) {
	print "Usage: #perl cr-014.pl [ --stype <type of system, script is running on>
