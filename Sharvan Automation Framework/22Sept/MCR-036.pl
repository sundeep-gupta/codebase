...
# 
# Script ID:			MCR-036
# Script Name:			MCR-036.pl
# Description:			Verifies integrity of non-compressible-data transferred using wget http from server to client at second level of compression
...
if ($help) {
	print "Usage: #perl cr-036.pl [ --stype <type of system, script is running on>
