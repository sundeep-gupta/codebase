...
# 
# Script ID:			MCR-144
# Script Name:			MCR-144.pl
# Description:			Verifies compression-ratio of non-compressible-data transferred using wget HTTP from client to server at second level of compression
...
if ($help) {
	print "Usage: #perl mcr-144.pl [ --size  <size of file>
