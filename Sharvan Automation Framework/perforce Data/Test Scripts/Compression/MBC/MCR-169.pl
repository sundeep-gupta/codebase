...
#
# Script ID:			MCR-169
# Script Name:			MCR-169.pl
# Description:			Verifies compression-ratio of compressible-data transferred using CIFS in multi-session [same data] from server to client at second level of compression
...
if ($help) {
	print "Usage: #perl mcr-169.pl [--size  <size of file>
