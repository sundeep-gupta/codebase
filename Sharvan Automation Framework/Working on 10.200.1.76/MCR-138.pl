...
# 
# Script ID:			MCR-138
# Script Name:			MCR-138.pl
# Description:			Verifies compression-ratio of mid-compressible-data transferred using FTP from client to server at second level of compression
...
if ($help) {
	print "Usage: #perl mcr-138.pl [ --size  <size of file>
