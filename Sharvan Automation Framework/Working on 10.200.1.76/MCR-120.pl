...
# 
# Script ID:			MCR-120
# Script Name:			MCR-120.pl
# Description:			Verifies compression-ratio of mid-compressible-data transferred using FTP from server to client at first level of compression
...
if ($help) {
	print "Usage: #perl mcr-120.pl [ --size  <size of file>
