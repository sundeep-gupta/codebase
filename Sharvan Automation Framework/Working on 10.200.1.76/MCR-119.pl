...
# 
# Script ID:			MCR-119
# Script Name:			MCR-119.pl
# Description:			Verifies compression-ratio of mid-compressible-data transferred using CIFS from server to client at first level of compression
...
if ($help) {
	print "Usage: #perl mcr-119.pl [ --size  <size of file>
