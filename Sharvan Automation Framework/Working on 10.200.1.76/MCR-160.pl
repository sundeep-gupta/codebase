...
#
# Script ID:			MCR-160
# Script Name:			MCR-160.pl
# Description:			Verifies compression-ratio of non-compressible-data transferred using FTP in multi-session [same data] from server to client at first level of compression
...
if ($help) {
	print "Usage: #perl mcr-160.pl [--size  <size of file>
