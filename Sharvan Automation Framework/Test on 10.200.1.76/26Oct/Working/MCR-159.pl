...
#
# Script ID:			MCR-159
# Script Name:			MCR-159.pl
# Description:			Verifies compression-ratio of non-compressible-data transferred using CIFS in multi-session [same data] from server to client at first level of compression
...
if ($help) {
	print "Usage: #perl mcr-159.pl [--size  <size of file>
