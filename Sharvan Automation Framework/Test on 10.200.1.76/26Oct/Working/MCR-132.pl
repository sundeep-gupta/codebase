...
# 
# Script ID:			MCR-132
# Script Name:			MCR-132.pl
# Description:			Verifies compression-ratio of non-compressible-data transferred using FTP from client to server at second level of compression
...
if ($help) {
	print "Usage: #perl mcr-132.pl [ --size  <size of file>
