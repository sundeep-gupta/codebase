...
# 
# Script ID:			MCR-140
# Script Name:			MCR-140.pl
# Description:			Verifies compression-ratio of mid-compressible-data transferred using wget HTTP from client to server at second level of compression
...
if ($help) {
	print "Usage: #perl mcr-140.pl [ --size  <size of file>
