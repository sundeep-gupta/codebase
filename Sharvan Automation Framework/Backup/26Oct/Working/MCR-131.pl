...
# 
# Script ID:			MCR-131
# Script Name:			MCR-131.pl
# Description:			Verifies compression-ratio of non-compressible-data transferred using CIFS from client to server at second level of compression
...
if ($help) {
	print "Usage: #perl mcr-131.pl [ --size  <size of file>
