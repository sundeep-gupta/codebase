...
#
# Script ID:			MCR-164
# Script Name:			MCR-164.pl
# Description:			Verifies compression-ratio of compressible-data transferred using FTP in multi-session [same data] from client to server at second level of compression
...
if ($help) {
	print "Usage: #perl mcr-164.pl [--size  <size of file>
