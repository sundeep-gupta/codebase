...
#
# Script ID:			MCR-196
# Script Name:			MCR-196.pl
# Description:			Verifies compression-ratio of non-compressible-data transferred using FTP in multi-session [different set of data] from server to client at first level of compression
...
if ($help) {
	print "Usage: #perl mcr-196.pl [--size  <size of file>
