...
#
# Script ID:			MCR-167
# Script Name:			MCR-167.pl
# Description:			Verifies compression-ratio of non-compressible-data transferred using CIFS in multi-session [same data] from client to server at second level of compression
...
if ($help) {
	print "Usage: #perl mcr-167.pl [--size  <size of file>
