...
# 
# Script ID:			MCR-127
# Script Name:			MCR-127.pl
# Description:			Verifies compression-ratio of compressible-data transferred using CIFS from client to server at second level of compression
...
if ($help) {
	print "Usage: #perl mcr-127.pl [ --size  <size of file>
