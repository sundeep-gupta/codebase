...
# 
# Script ID:			MCR-054
# Script Name:			MCR-054.pl
# Description:			Verifies integrity of non-compressible-data transferred using wget http in multi-session [same data] from server to client at first level of compression
...
if ($help) {
	print "Usage: #perl mcr-054.pl [ --stype <type of system, script is running on>
