...
# 
# Script ID:			MCR-080
# Script Name:			MCR-080.pl
# Description:			Verifies integrity of compressible-data transferred using FTP in multi-session [different set of data] from server to client at first level of compression
...
if ($help) {
	print "Usage: #perl mcr-080.pl [ --stype <type of system, script is running on>
