...
# 
# Script ID:			MCR-090
# Script Name:			MCR-090.pl
# Description:			Verifies integrity of non-compressible-data transferred using wget http in multi-session [different set of data] from server to client at first level of compression
...
if ($help) {
	print "Usage: #perl mcr-090.pl [ --stype <type of system, script is running on>
