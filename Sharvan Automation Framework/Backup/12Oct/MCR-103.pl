...
# 
# Script ID:			MCR-103
# Script Name:			MCR-103.pl
# Description:			Verifies integrity of mid-compressible-data transferred using wget ftp in multi-session [different set of data] from server to client at second level of compression
...
if ($help) {
	print "Usage: #perl mcr-103.pl [ --stype <type of system, script is running on>
