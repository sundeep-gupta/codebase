...
# 
# Script ID:			MCR-040
# Script Name:			MCR-040.pl
# Description:			Verifies integrity of mid-compressible-data transferred using FTP in multi-session [same data] from client to server at first level of compression
...
if ($help) {
	print "Usage: #perl mcr-040.pl [ --stype <type of system, script is running on>
