...
# 
# Script ID:			MCR-075
# Script Name:			MCR-075.pl
# Description:			Verifies integrity of mid-compressible-data transferred using CIFS in multi-session [different set of data] from client to server at first level of compression
...
if ($help) {
	print "Usage: #perl mcr-075.pl [ --stype <type of system, script is running on>
