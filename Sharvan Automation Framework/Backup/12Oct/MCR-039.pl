...
# 
# Script ID:			MCR-039
# Script Name:			MCR-039.pl
# Description:			Verifies integrity of mid-compressible-data transferred using CIFS in multi-session [same data] from client to server at first level of compression
...
if ($help) {
	print "Usage: #perl mcr-039.pl [ --stype <type of system, script is running on>
