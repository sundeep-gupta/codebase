...
# 
# Script ID:			MCR-100
# Script Name:			MCR-100.pl
# Description:			Verifies integrity of compressible-data transferred using wget http in multi-session [different set of data] from server to client at second level of compression
...
if ($help) {
	print "Usage: #perl mcr-100.pl [ --stype <type of system, script is running on>
