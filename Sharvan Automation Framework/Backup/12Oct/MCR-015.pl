...
# Description:			Verifies integrity of non-compressible-data transferred using CIFS from server to client at first level of compression
...
if ($help) {
	print "Usage: #perl mcr-015.pl [ --stype <type of system, script is running on>
