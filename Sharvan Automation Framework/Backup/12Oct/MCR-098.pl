...
# 
# Script ID:			MCR-098
# Script Name:			MCR-098.pl
# Description:			Verifies integrity of compressible-data transferred using FTP in multi-session [different set of data] from server to client at second level of compression
...
if ($help) {
	print "Usage: #perl mcr-098.pl [ --stype <type of system, script is running on>
