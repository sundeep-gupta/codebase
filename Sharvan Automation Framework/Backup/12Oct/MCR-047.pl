...
# Description:			Verifies integrity of mid-compressible-data transferred using CIFS in multi-session [same data] from server to client at first level of compression
...
if ($help) {
	print "Usage: #perl mcr-047.pl [ --stype <type of system, script is running on>
