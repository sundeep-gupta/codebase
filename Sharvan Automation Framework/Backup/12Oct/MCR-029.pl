...
# Description:			Verifies integrity of mid-compressible-data transferred using CIFS from server to client at second level of compression
...
if ($help) {
	print "Usage: #perl mcr-029.pl [ --stype <type of system, script is running on>
