...
# 
# Script ID:			MCR-077
# Script Name:			MCR-077.pl
# Description:			Verifies integrity of non-compressible-data transferred using CIFS in multi-session [different set of data] from client to server at first level of compression
...
if ($help) {
	print "Usage: #perl mcr-077.pl [ --stype <type of system, script is running on>
