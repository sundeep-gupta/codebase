...
# 
# Script ID:			MCR-037
# Script Name:			MCR-037.pl
# Description:			Verifies integrity of compressible-data transferred using CIFS in multi-session [same data] from client to server at first level of compression
...
if ($help) {
	print "Usage: #perl mcr-037.pl [ --stype <type of system, script is running on>
