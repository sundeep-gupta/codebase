...
# 
# Script ID:			MCR-050
# Script Name:			MCR-050.pl
# Description:			Verifies integrity of mid-compressible-data transferred using wget http in multi-session [same data] from server to client at first level of compression
...
if ($help) {
	print "Usage: #perl mcr-050.pl [ --stype <type of system, script is running on>
