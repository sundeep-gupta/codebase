...
# 
# Script ID:			MCR-055
# Script Name:			MCR-055.pl
# Description:			Verifies integrity of compressible-data transferred using CIFS in multi-session [same data] from client to server at second level of compression
...
if ($help) {
	print "Usage: #perl mcr-055.pl [ --stype <type of system, script is running on>
