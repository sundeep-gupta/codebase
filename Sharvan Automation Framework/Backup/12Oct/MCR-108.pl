...
# 
# Script ID:			MCR-108
# Script Name:			MCR-108.pl
# Description:			Verifies integrity of non-compressible-data transferred using wget http in multi-session [different set of data] from server to client at second level of compression
...
if ($help) {
	print "Usage: #perl mcr-108.pl [ --stype <type of system, script is running on>
