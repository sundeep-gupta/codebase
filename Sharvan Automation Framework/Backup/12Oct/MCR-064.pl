...
# 
# Script ID:			MCR-064
# Script Name:			MCR-064.pl
# Description:			Verifies integrity of compressible-data transferred using wget http in multi-session [same data] from server to client at second level of compression
...
if ($help) {
	print "Usage: #perl mcr-064.pl [ --stype <type of system, script is running on>
