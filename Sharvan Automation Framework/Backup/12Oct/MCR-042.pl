...
# 
# Script ID:			MCR-042
# Script Name:			MCR-042.pl
# Description:			Verifies integrity of non-compressible-data transferred using FTP in multi-session [same data] from client to server at first level of compression
...
if ($help) {
	print "Usage: #perl mcr-042.pl [ --stype <type of system, script is running on>
