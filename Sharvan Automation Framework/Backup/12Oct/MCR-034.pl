...
# Description:			Verifies integrity of non-compressible-data transferred using FTP from server to client at second level of compression
...
if ($help) {
	print "Usage: #perl mcr-034.pl [ --stype <type of system, script is running on>
