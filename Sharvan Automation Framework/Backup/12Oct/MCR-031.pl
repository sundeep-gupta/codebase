...
# 
# Script ID:			MCR-031
# Script Name:			MCR-031.pl
# Description:			Verifies integrity of mid-compressible-data transferred using wget ftp from server to client at second level of compression
...
if ($help) {
	print "Usage: #perl mcr-031.pl [ --stype <type of system, script is running on>
