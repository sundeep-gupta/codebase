...
# 
# Script ID:			MCR-043
# Script Name:			MCR-043.pl
# Description:			Verifies integrity of compressible-data transferred using CIFS in multi-session [same data] from server to client at first level of compression
...
if ($help) {
	print "Usage: #perl mcr-043.pl [ --stype <type of system, script is running on>
