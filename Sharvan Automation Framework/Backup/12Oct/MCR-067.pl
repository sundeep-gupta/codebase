...
# 
# Script ID:			MCR-067
# Script Name:			MCR-067.pl
# Description:			Verifies integrity of mid-compressible-data transferred using wget ftp in multi-session [same data] from server to client at second level of compression
...
if ($help) {
	print "Usage: #perl mcr-067.pl [ --stype <type of system, script is running on>
