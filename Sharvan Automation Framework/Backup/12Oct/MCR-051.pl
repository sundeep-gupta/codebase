...
# 
# Script ID:			MCR-051
# Script Name:			MCR-051.pl
# Description:			Verifies integrity of non-compressible-data transferred using CIFS in multi-session [same data] from server to client at first level of compression
...
if ($help) {
	print "Usage: #perl mcr-051.pl [ --stype <type of system, script is running on>
