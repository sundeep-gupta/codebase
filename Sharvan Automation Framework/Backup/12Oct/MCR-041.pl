...
# 
# Script ID:			MCR-041
# Script Name:			MCR-041.pl
# Description:			Verifies integrity of non-compressible-data transferred using CIFS in multi-session [same data] from client to server at first level of compression
...
if ($help) {
	print "Usage: #perl mcr-041.pl [ --stype <type of system, script is running on>
