...
# 
# Script ID:			MCR-106
# Script Name:			MCR-106.pl
# Description:			Verifies integrity of non-compressible-data transferred using FTP in multi-session [different set of data] from server to client at second level of compression
...
if ($help) {
	print "Usage: #perl mcr-106.pl [ --stype <type of system, script is running on>
