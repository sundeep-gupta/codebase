...
# 
# Script ID:			MCR-072
# Script Name:			MCR-072.pl
# Description:			Verifies integrity of non-compressible-data transferred using wget http in multi-session [same data] from server to client at second level of compression
...
if ($help) {
	print "Usage: #perl mcr-072.pl [ --stype <type of system, script is running on>
