...
# 
# Script ID:			MCR-063
# Script Name:			MCR-063.pl
# Description:			Verifies integrity of compressible-data transferred using wget ftp in multi-session [same data] from server to client at second level of compression
...
if ($help) {
	print "Usage: #perl mcr-063.pl [--size  <size of file>
