...
# 
# Script ID:			MCR-005
# Script Name:			MCR-005.pl
# Description:			Verifies integrity of non-compressible-data transferred using CIFS from client to server at first level of compression
...
if ($help) {
	print "Usage: #perl mcr-005.pl [ --stype <type of system, script is running on>
