...
# 
# Script ID:			MCR-046
# Script Name:			MCR-046.pl
# Description:			Verifies integrity of compressible-data transferred using wget http in multi-session [same data] from server to client at first level of compression
