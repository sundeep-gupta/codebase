...
# 
# Script ID:			MCR-038
# Script Name:			MCR-038.pl
# Description:			Verifies integrity of compressible-data transferred using FTP in multi-session [same data] from client to server at first level of compression
...
if ($help) {
	print "Usage: #perl mcr-038.pl [ --stype <type of system, script is running on>
