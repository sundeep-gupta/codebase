...
# 
# Script ID:			MCR-114
# Script Name:			MCR-114.pl
# Description:			Verifies compression-ratio of non-compressible-data transferred using FTP from client to server at first level of compression
...
if ($help) {
	print "Usage: #perl mcr-114.pl [ --size  <size of file>
