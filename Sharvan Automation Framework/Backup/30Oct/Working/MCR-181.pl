...
#
# Script ID:			MCR-181
# Script Name:			MCR-181.pl
# Description:			Verifies compression-ratio of compressible-data transferred using CIFS in multi-session [different set of data] from client to server at first level of compression
...
if ($help) {
	print "Usage: #perl mcr-181.pl [--size  <size of file>
