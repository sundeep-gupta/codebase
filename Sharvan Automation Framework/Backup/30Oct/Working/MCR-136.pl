...
# 
# Script ID:			MCR-136
# Script Name:			MCR-136.pl
# Description:			Verifies compression-ratio of compressible-data transferred using wget HTTP from client to server at second level of compression
...
if ($help) {
	print "Usage: #perl mcr-136.pl [ --size  <size of file>
