...
# 
# Script ID:			MCR-007
# Script Name:			MCR-007.pl
# Description:			Verifies integrity of compressible-data transferred using CIFS from server to client at first level of compression
...
if ($help) {
	print "Usage: #perl mcr-007.pl [ --size  <size of file>
