...
# 
# Script ID:			MCR-009
# Script Name:			MCR-009.pl
# Description:			Verifies integrity of compressible-data transferred using wget ftp from server to client at first level of compression
...
if ($help) {
	print "Usage: #perl mcr-009.pl [ --size  <size of file>
