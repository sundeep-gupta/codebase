...
# 
# Script ID:			MCR-008
# Script Name:			MCR-008.pl
# Description:			Verifies integrity of compressible-data transferred using FTP from server to client at first level of compression
...
if ($help) {
	print "Usage: #perl mcr-008.pl [ --size  <size of file>
