...
sub new {
    ...
    my $CONFIG = {
		"ORBITAL1"		  => "10.200.199.90",						 # Orbital 1 IP address; will come from console
		"ORBITAL2"		  => "10.200.199.97",						 # Orbital 2 IP address; will come from console
		"NODE1"			  => "10.200.1.76",							 # NODE1 will be treated as server
		...
		"SERVER_LIB_URL"  => "http://10.200.1.76/cgi-bin/xml-rpc/library/Server_Library.cgi",
