...
# 
# Script ID:			MCR-048
# Script Name:			MCR-048.pl
# Description:			Verifies integrity of mid-compressible-data transferred using FTP in multi-session [same data] from server to client at first level of compression
...
if ($help) {
	print "Usage: #perl cr-048.pl [ --stype <type of system, script is running on>
