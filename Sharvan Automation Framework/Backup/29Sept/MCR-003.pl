...
# 
# Script ID:			MCR-003
# Script Name:			MCR-003.pl
# Description:			Verifies integrity of mid-compressible-data transferred using CIFS from client to server at first level of compression
...
if ($help) {
	print "Usage: #perl mcr-003.pl [ --stype <type of system, script is running on>
