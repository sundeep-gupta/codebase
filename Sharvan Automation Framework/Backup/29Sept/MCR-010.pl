...
# 
# Script ID:			MCR-010
# Script Name:			MCR-010.pl
# Description:			Verifies integrity of compressible-data transferred using wget http from server to client at first level of compression
...
if ($help) {
	print "Usage: #perl cr-010.pl [ --stype <type of system, script is running on>
