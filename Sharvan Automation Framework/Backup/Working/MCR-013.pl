...
# 
# Script ID:			MCR-013
# Script Name:			MCR-013.pl
# Description:			Verifies integrity of mid-compressible-data transferred using wget ftp from server to client at first level of compression
...
if ($help) {
	print "Usage: #perl mcr-013.pl [ --stype <type of system, script is running on>
