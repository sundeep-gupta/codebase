...
# 
# Script ID:			MCR-081
# Script Name:			MCR-081.pl
# Description:			Verifies integrity of compressible-data transferred using wget ftp in multi-session [different set of data] from server to client at first level of compression
...
if ($help) {
	print "Usage: #perl mcr-081.pl [ --stype <type of system, script is running on>
