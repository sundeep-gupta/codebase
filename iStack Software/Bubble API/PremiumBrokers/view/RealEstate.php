...
class RealEstate extends Div{
	...
	$data = '';
	if($_SESSION['db_message']) {
	    $data .= '<center><span class="grey">'.$_SESSION['db_message'].'</span></center><br/>';
	    $data .= mysql_error();
...
<strong>We serve as a one-stop shop for those looking to own, occupy, 
...
<br />
Services Offered for Indian residents & NRIs:</p>
<ul>
