...
*/
  ...
  class tableBox {
    protected $table_border          = '0';
    protected $table_width           = '100%';
    protected $table_cellspacing     = '0';
    protected $table_cellpadding     = '2';
    protected $table_parameters      = '';
    protected $table_row_parameters  = '';
    protected $table_data_parameters = '';
...
// class constructor
    ...
    function __construct($contents, $direct_output = false) {
      ...
      $tableBox_string = '<table border="' . tep_output_string($this->table_border) . 
	                       '" width="' . tep_output_string($this->table_width) . 
	                       '" cellspacing="' . tep_output_string($this->table_cellspacing) . 
                               '" cellpadding="' . tep_output_string($this->table_cellpadding) . '"';
