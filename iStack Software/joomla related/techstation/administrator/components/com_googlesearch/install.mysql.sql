DROP TABLE IF EXISTS `#__googleSearch_conf`;
CREATE TABLE `#__googleSearch_conf` (
`id` int NOT NULL,
...
INSERT INTO `#__googleSearch_conf` (id, google_id, width, width_searchfield, search_button_label, channel, domain, domain_name, domain_as_default, 
...
'left', 'below', 'right', '1', '', 'top_bottom',
'text', '#AAAAAA', '#000000', '#FFFFFF', '#FFFFFF', 'search...', '',
16, '1', '0', 
'none', 'below', 'below', '2', '',
