...
$xml_submenu[6] = array (0 => "Comments", 1 => "option=com_phocagallery&view=phocagallerycos", 2 => "components/com_phocagallery/assets/images/icon-16-pg-menu-comment.png");
//$xml_submenu[6] = array (0 => "Users Categories", 1 => "option=com_phocagallery&view=phocagalleryucs", 2 => "components/com_phocagallery/assets/images/icon-16-pg-menu-users-cat.png");
$xml_submenu[7] = array (0 => "Info", 1 => "option=com_phocagallery&view=phocagalleryin", 2 => "components/com_phocagallery/assets/images/icon-16-pg-menu-info.png");
