...
<div class="col100">
	<fieldset class="adminform">
		<legend><?php echo JText::_( 'CC_CONFIGURATION' ); ?></legend>

		<table class="admintable">
		<tr>
			<td  align="right" class="key" style="width:220px;">
				<label for="Newsletter Name">
					<?php echo JText::_( 'CC_ACKNOWLEDGEMENT_OFF' ); ?>:
				</label>
			</td>
			<td>
				<?php
					echo JHTML::_('select.booleanlist',  'status', '', $this->acknowledgementrow->status );
				?>
			</td>
		</tr>
		<tr>
			<td align="right" class="key">
				<label for="Newsletter Name">
					<?php echo JText::_( 'CC_SYN_ACKNOWLEDGEMENT_ON' ); ?>:
				</label>
			</td>
			<td>
				<?php
					echo JHTML::_('select.booleanlist',  'synstatus', '', $this->acknowledgementrow->synstatus );
				?>
			</td>
		</tr>
		<tr>
			<td  align="right" class="key">
				<label for="Newsletter Name">
					<?php echo JText::_( 'CC_EMAIL_ACTIVATION' ); ?>:
				</label>
			</td>
			<td>
				<?php
					echo JHTML::_('select.booleanlist',  'activation', '', $this->acknowledgementrow->activation );
				?>
			</td>
		</tr>
	</table>
...
ccNewsletter, Joomla! component by <a href="http://www.extensions.chillcreations.com" target="_blank">Chill Creations</a>  Copyright <?php echo date("Y") ?>
</p>
