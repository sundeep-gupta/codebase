...
<div class="art-Logo">
 <h1 id="name-text" class="art-Logo-name"><a href="<?php echo $baseUrl; ?>/">FunStation</a></h1>
 <div id="slogan-text" class="art-Logo-text">Lets stop for some fun!</div>
</div>
...
<p>Copyright &copy; 2010 Bubble Inc., All Rights Reserved.</p>
...
<div class="cleared"></div>
<p class="art-page-footer">Sponsored by <a href="http://www.flowerdelivery.co.uk/">flower delivery</a></p>
</div>
