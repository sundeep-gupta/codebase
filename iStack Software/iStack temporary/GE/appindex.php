...
function ajaxFunctionRep(){
	var ajaxRequest;  // The variable that makes Ajax possible!
	var argv = ajaxFunctionRep.arguments;
	var t2id = argv[0];
...
<form class="form2" name="myForm" onsubmit="return button_1();">
<div class="row">
<div class="four columns">
<input class="text" type="text" size="35" id="taskname" name="tname" required placeholder="Enter task here.." pattern="[0-9][A-Z]{3}"/>
</div>
...
<input type="button" class="button_add3" onClick="window.location='logout.php'"  />
   <input type="button" class="button_add5" onClick="ajaxFunctionRep()"  />
<!--input type="button" class="button_add3" onClick="window.location='logout.php'"  /-->
