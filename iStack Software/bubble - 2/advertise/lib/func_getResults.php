...
?>
        ...
        <table cellpadding="0" cellspacing="0" border="0" width="<?php echo  cnfg('rowsOfAdsTableWidth') ?>">
        <tr>
            <th align="center" bgcolor="<?php echo $bgcolor ?>">
            ...
            <th align="left" bgcolor="<?php echo $bgcolor ?>">
                <FONT COLOR="#000000" FACE="Arial">
                <B>Description</B>
                </FONT>
            </th>
...
?>
            Sorry, no matches.<BR>
            <a href="<?php echo cnfg('deDir'); ?>search.php">Search again.</a>
<?php    
        } else {
?>     
