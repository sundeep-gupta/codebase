...
function path_cnfg($the_key){
   ...
   */
	 ...
	 */
    $path_cnfg['pathToLibDir'] = '/home/httpd/vhosts/bubble.co.in//httpdocs/advertise/lib/'; 
	 ...
	 */
    $path_cnfg['pathToCnfgDir'] = '/home/httpd/vhosts/bubble.co.in/httpdocs/advertise/cnfg/'; 
	 ...
	 */
	$path_cnfg['pathToAdminScriptsDir'] = '/home/httpd/vhosts/bubble.co.in/httpdocs/advertise/admin/admin_scripts/';

    /* Path to directory named "templates".
	 * You can put this directory above your 
	 * web root if you wish.
	 */	
	$path_cnfg['pathToTemplatesDir'] = '/home/httpd/vhosts/bubble.co.in/httpdocs/advertise/templates/';
