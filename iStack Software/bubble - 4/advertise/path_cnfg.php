...
function path_cnfg($the_key){
   ...
   */
	 ...
	 */
    $path_cnfg['pathToLibDir'] = '/srv/www/htdocs/prj1/advertise/lib/'; 
	 ...
	 */
    $path_cnfg['pathToCnfgDir'] = '/srv/www/htdocs/prj1/advertise/cnfg/'; 
	 ...
	 */
	$path_cnfg['pathToAdminScriptsDir'] = '/srv/www/htdocs/prj1/advertise/admin/admin_scripts/';

    /* Path to directory named "templates".
	 * You can put this directory above your 
	 * web root if you wish.
	 */	
	$path_cnfg['pathToTemplatesDir'] = '/srv/www/htdocs/prj1/advertise/templates/';
