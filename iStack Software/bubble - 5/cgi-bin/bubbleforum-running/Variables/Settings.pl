...
$mbname = q^Bubble Space!!!^;                                         # The name of your YaBB forum
$forumstart = "06/01/07 at 17:17:01";                                 # The start date of your YaBB Forum
$Cookie_Length = 1;                                                   # Default minutes to set login cookies to stay for
$cookieusername = "Y2User-73902";                                     # Name of the username cookie
$cookiepassword = "Y2Pass-73902";                                     # Name of the password cookie
$cookiesession_name = "Y2Sess-73902";                                 # Name of the Session cookie

$regdisable = 1;                                                      # Set to 1 to disable user registration (only admin can register)
...
$default_template = "r2";                                             # Default Forum Template
...
$authuser = q^admin^;                                                 # Username for SMTP authorisation
$authpass = q^admin^;                                                 # Password for SMTP authorisation
$webmaster_email = q^razikh@bubble.co.in^;                            # Your email address. (eg: $webmaster_email = q^admin@host.com^;)
...
$timeoffset = 5.5;                                                    # Time Offset to GMT/UTC (0 for GMT/UTC)
...
$maxrecentdisplay = 25;                                               # Maximum of topics to display on recent posts by a user (-1 to disable)
...
$defaultusertxt = qq~I love 2 be @ Bubble~;                           # The dafault usertext visible in users posts
