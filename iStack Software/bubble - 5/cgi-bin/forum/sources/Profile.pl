...
sub ProfileCheck {
	...
	$yymain .= qq~
		...
		<table id="board-head">
		<tr><th colspan="2"><b>$profile_txt{'901'}</b></th></tr>
		...
		<div style="clear: both; padding-top: 4px; margin-left: auto; margin-right: auto; width: 370px;">
			<span style="float: left; width: 100%; text-align: center; align: center;">
				<br/><input type="password" name="passwrd" size="15" style="width: 150px;" tabindex="2" />
			</span>
		</div>
...
sub ProfileMenu {
	...
	$yymain .= qq~
      ...
      <table id="profile-menu">
        <tr>
          <td valign="bottom" width="16%"><a href="$scripturl?action=profile;username=$INFO{'username'};sid=$INFO{'sid'}">$profile_txt{79}</a></td>
          <td valign="bottom" width="16%"><a href="$scripturl?action=profileContacts;username=$INFO{'username'};sid=$INFO{'sid'}">$profile_txt{819}</a></td>
          <td valign="bottom" width="16%"><a href="$scripturl?action=profileOptions;username=$INFO{'username'};sid=$INFO{'sid'}">$profile_txt{818}</a></td>
          <td valign="bottom" width="16%"><a href="$scripturl?action=profileIM;username=$INFO{'username'};sid=$INFO{'sid'}">$profile_imtxt{56} $profile_txt{323}</a></td>~;
	if ($iamadmin) {
		$yymain .= qq~
...
<table cellspacing="1" cellpadding="4" width="100%" align="center" id="board" border="0">
  <tr>
    <th colspan="3"><img src="$imagesdir/profile.gif" alt="" border="0" /> <b>$profile_txt{79} ($INFO{'username'})</b><br /><span class="small">$profile_txt{'698'}</span></th>
  </tr><tr>
   <td width="1%">&nbsp;</td>
   <td width="25%"><b>$profile_txt{81}: </b><br />
	<span class="small">$profile_txt{'896'}</span>
   </td>
   <td width="70%">
	<input type="password" maxlength="30" name="passwrd1" size="20" />
   </td>
 </tr><tr>
 <td width="1%">&nbsp;</td>
   <td width="25%" align="left"><b>$profile_txt{82}: </b><br />
<span class="small">$profile_txt{'896'}</span>
</td>
...
~;
  ...
  <tr>
  <td width="1%">&nbsp;</td>
    <td colspan="2"><img src="$imagesdir/session.gif" alt="" border="0" /> <b>$img_txt{'34a'}</b><br /><span class="small">$session_txt{'9'}<br />$session_txt{'9a'}</span></td>
  </tr><tr>
	<td width="1%">&nbsp;</td>
...
<td width="1%">&nbsp;</td>
   ...
   <center>
   <input type="submit" name="moda" value="$profile_txt{'88'}" />
   &nbsp;&nbsp;&nbsp; &nbsp;
   <input type="submit" name="moda" value="$profile_txt{'89'}" onclick="return confirm('$confdel_text')" />
   </center>
   </td>
 </tr>
</table>
...
<table id="board">
  <tr>
    <th colspan="3" class="catbg"><img src="$imagesdir/profile.gif" alt="" border="0" /> <b>$profile_txt{79} ($INFO{'username'}) » $profile_txt{819}</b></th>
  </tr><tr >
    <td width="1%">&nbsp;</td>
    <td width="310" align="left"><b>$profile_txt{'69'}: </b><br /><span class="small">$profile_txt{'679'} </span></td>
	...
	if ($allow_hide_email) {
		...
		$yymain .= qq~<tr>
		<td width="1%">&nbsp;</td>
          <td width="310" align="left"><b>$profile_txt{'721'}</b></td>
          <td align="left"><input type="checkbox" name="hideemail" value="checked" $checked /></td>
        </tr>~;
	}
	$yymain .= qq~<tr>
	<td width="1%">&nbsp;</td>
     <td width="310" align="left"><b>$profile_txt{'513'}: </b><br /><span class="small">$profile_txt{'600'}</span></td>
     <td align="left"><input type="text" maxlength="10" name="icq" size="40" value="${$uid.$user}{'icq'}" /></td>
   </tr><tr>
   <td width="1%">&nbsp;</td>
     <td width="310" align="left"><b>$profile_txt{'603'}: </b><br /><span class="small">$profile_txt{'601'}</span></td>
     <td align="left"><input type="text" maxlength="30" name="aim" size="40" value="${$uid.$user}{'aim'}" /></td>
   </tr><tr>
   <td width="1%">&nbsp;</td>
     <td width="310"><b>$profile_txt{'604'}: </b><br /><span class="small">$profile_txt{'602'}</span></td>
     <td align="left"><input type="text" maxlength="30" name="yim" size="40" value="${$uid.$user}{'yim'}" /></td>
   </tr><tr>
   <td width="1%">&nbsp;</td>
     <td width="310"><b>$profile_txt{'823'}: </b><br /><span class="small">$profile_txt{'824'}</span></td>
     <td align="left"><input type="text" maxlength="50" name="msn" size="40" value="${$uid.$user}{'msn'}" /></td>
   </tr><tr>
   <td width="1%">&nbsp;</td>
     <td width="310"><b>$profile_txt{'825'}: </b><br /><span class="small">$profile_txt{'826'}</span></td>
     <td align="left"><input type="text" maxlength="50" name="gtalk" size="40" value="${$uid.$user}{'gtalk'}" /></td>
   </tr><tr>
	<td width="1%">&nbsp;</td>
     <td width="310" align="left"><b>$profile_txt{'83'}: </b><br /><span class="small">$profile_txt{'598'}</span></td>
     <td align="left"><input type="text" maxlength="30" name="webtitle" size="50" value="${$uid.$user}{'webtitle'}" /></td>
   </tr><tr>
   <td width="1%">&nbsp;</td>
     <td width="310" align="left"><b>$profile_txt{'84'}: </b><br /><span class="small">$profile_txt{'599'}</span></td>
...
<table id="board">
  <tr>
    <th colspan="3" class="catbg"><img src="$imagesdir/profile.gif" alt="" border="0" /><b>$profile_txt{'79'} ($INFO{'username'}) » $profile_txt{818}</b></th>
  </tr><tr>~;
	...
	if ($allowpics) {
		...
		$yymain .= qq~
	  <td width="1%">&nbsp;</td>
          <td width="310" align="left"><b>$profile_txt{'229'}:</b><br /><span class="small">$profile_txt{'474'}</span></td>
          <td align="left">
...
$images            </select>
		...
		<td width="1%">&nbsp;</td>
          <td width="310" align="left"><b>$profile_txt{'475'}</b></td>
	...
	$yymain .= qq~<tr>
	<td width="1%">&nbsp;</td>
          <td width="320"><b>$profile_txt{'228'}: </b></td>
          <td ><input type="text" name="usertext" size="50" value="${$uid.$user}{'usertext'}" maxlength="50" /></td>
        </tr><tr>
	<td width="1%">&nbsp;</td>
          <td width="320"><b>$profile_txt{'85'}:</b><br /><span class="small">$profile_txt{'606'}</span></td>
          <td><textarea name="signature" rows="4" cols="50">$signature</textarea><br />
	...
	<td width="1%">&nbsp;</td>
          <td width="310"><b>$profile_txt{'486'}:</b><br />
       ...
       <td width="1%">&nbsp;</td>
          <td width="310" align="left"><b>$profile_txt{'486a'}:</b><br />
	...
	<td width="1%">&nbsp;</td>
          <td width="310"><b>$profile_txt{'371'}:</b><br /><span class="small">$profile_txt{'519'}</span></td>
          <td><span class="small"><select name="usertimeoffset">
       ...
       <td width="1%">&nbsp;</td>
          <td width="310"><b>$profile_txt{'519a'}</b></td>
          <td><input type="checkbox" name="dsttimeoffset"$dsttimechecked /></td>
        </tr>
~;
	&CheckNewTemplates;
	...
	<td width="1%">&nbsp;</td>
          <td width="310"><b>$profile_txt{'814'}</b></td>
          <td><select name="usertemplate">$drawndirs</select></td>
        </tr>~;
	...
	$yymain .= qq~<tr>
	<td width="1%">&nbsp;</td>
          <td width="320"><b>$profile_txt{'817'}</b></td>
          <td><select name="userlanguage">$drawnldirs</select></td>
        </tr><tr>
          <td height="30" valign="middle" colspan="3">
	  <center>
	  <input type="submit" name="moda" value="$profile_txt{'88'}" />
...
<table id="board">
 <tr>
   <th colspan="3"><img src="$imagesdir/profile.gif" alt="" border="0" /><b>$profile_txt{79} ($INFO{'username'}) » $profile_imtxt{38}</b></th>
 </tr><tr>
   <td width="1%">&nbsp;</td>
...
<table id="board">
 <tr>
   <td colspan="3"><img src="$imagesdir/profile.gif" alt="" border="0" /> <b>$profile_txt{79} ($INFO{'username'}) » $profile_txt{820}</b><input type="hidden" name="username" value="$INFO{'username'}" /></td>
 </tr><tr >
 <td width="1%">&nbsp;</td>
   <td width="310" align="left"><b>$profile_txt{'21'}: </b></td>
   <td align="left"><input type="text" name="settings6" size="4" value="${$uid.$user}{'postcount'}" /></td>
 </tr><tr>
 <td width="1%">&nbsp;</td>
   <td width="310"><b>$profile_txt{'87'}: </b></td>
   <td>
...
~;
 ...
 <tr>
 <td width="1%">&nbsp;</td>
   <td width="310" valign="top"><b>$profile_txt{'87a'}: </b><br /><span class="small">$profile_txt{'87b'}</span></td>
   <td>
...
~;
 ...
 <tr>
 <td width="1%">&nbsp;</td>
    <td width="310"><b>$profile_txt{'233'}:</b></td>
    <td valign="middle">$all_date $maintxt{'107'} $all_time</td>
 </tr><tr>
 <td width="1%">&nbsp;</td>
    <td width="310"><b>$profile_amv_txt{'9'}: </b></td>
    <td>$userlastlogin</td>
 </tr><tr>
 <td width="1%">&nbsp;</td>
    <td width="310" align="left"><b>$profile_amv_txt{'10'}: </b></td>
    <td >$userlastpost</td>
 </tr><tr>
 <td width="1%">&nbsp;</td>
    <td width="310"><b>$profile_amv_txt{'11'}: </b><br /><br /></td>
...
sub ModifyProfileContacts2 {
	...
	if ($member{'moda'} eq $profile_txt{'88'}) {
		...
		# Time to print the changes to the username.vars file
		${$uid.$user}{'email'}    = $FORM{'email'};
		${$uid.$user}{'hidemail'} = $FORM{'hideemail'};
		${$uid.$user}{'icq'}      = $FORM{'icq'};
		${$uid.$user}{'msn'}      = $FORM{'msn'};
		${$uid.$user}{'yim'}      = $FORM{'yim'};
		${$uid.$user}{'aim'}      = $FORM{'aim'};
		${$uid.$user}{'msn'}      = $FORM{'msn'};
		${$uid.$user}{'gtalk'}    = $FORM{'gtalk'};
		${$uid.$user}{'webtitle'} = $FORM{'webtitle'};
		${$uid.$user}{'weburl'}   = $FORM{'weburl'};
		&UserAccount($user, "update");
		&WriteLog;
...
sub ModifyProfileIM2 {
	...
	$notify     = "$FORM{'notify'}";
	$popup      = "$FORM{'userpopup'}";
	$imspop     = "$FORM{'popupims'}";
	...
	${$uid.$user}{'im_notify'}     = "$notify";
	${$uid.$user}{'im_popup'}      = "$popup";
	${$uid.$user}{'im_imspop'}     = "$imspop";
	&UserAccount($user, "update");
	if (!$iamadmin) {
...
sub ViewProfile {
	...
	&fatal_error("$profile_txt{'223'}") if ($iamguest); 
	&fatal_error("$profile_txt{'224'}") if ($INFO{'username'} =~ /\//) ; 
	&fatal_error("$profile_txt{'225'}") if ($INFO{'username'} =~ /\\/) ; 
	&fatal_error("$profile_txt{'453'}") unless (-e ("$memberdir/$INFO{'username'}.vars")) ;
	...
	my $user = $INFO{'username'};
	&LoadUser($user) if (!${$uid.$user}{'password'}) ; 

	${$uid.$user}{'weburl'} = "http://${$uid.$user}{'weburl'}" if (${$uid.$user}{'weburl'} !~ m~\Ahttp://~);
	...
	if ($isbday) {
		$isbday = "<img src=\"$imagesdir/bdaycake.gif\" width=\"40\" />";
	}
	...
	if ($allowpics) {
		...
		if ($ENV{'HTTP_USER_AGENT'} !~ /MSIE/ || $ENV{'HTTP_USER_AGENT'} =~ /Opera/) {
			if ($ENV{'HTTP_USER_AGENT'} =~ /Safari/) {
				$avstyle = qq~ style="max-width: 65px; max-height: 65px;"~;
			} else {
				$avstyle = qq~ style="max-width: 65px;"~;
			}
		}
	...
	if ($string_regdate < $forumstart) {
		$string_regdate = $forumstart;
	}
	if ($string_curdate < $forumstart) {
		$string_curdate = $forumstart;
	}

	$member_for_days = int(($string_curdate - $string_regdate) / 86400);

	if ($member_for_days < 1) {
		$tmpmember_for_days = 1;
	} else {
		$tmpmember_for_days = $member_for_days;
	}
...
sub usersrecentposts {
	...
	$yymain .= qq~
<p align=left  style='margin-left: 10px'><a href="$scripturl?action=viewprofile;username=$useraccount{$curuser}"><b>$profile_txt{'92'} $curuser</b></a></p>
~;
	...
	for ($i = 0; $i < @messages; $i++) {
		...
		$yymain .= qq~
<table id="board" style="table-layout: fixed;">
  <tr>
  <th width="1%"></th>
    <th width="4%" ><span class="text1">$counter</span></th>
    <th width="95%"><span class="text1"><b>&nbsp;$catname{$board} / $boardname{$board} / <a href="$scripturl?num=$tnum/$c#$c"><span class="text1" ><u>$msub</u></span></a></b></span><br />
    <span class="small" >$profile_txt{'30'}: $mdate&nbsp;</span></th>
  </tr><tr height="80">
	<td width="1%"></td>
...
~;
	...
	if ($counter <= 1) { $yymain .= "<span class=\"text1\"><b>$profile_txt{'755'}</b></span>"; }
		...
		$yymain .= qq~
<p align=left style='margin-left: 10px'><a href="$scripturl?action=viewprofile;username=$useraccount{$curuser}"><b>$profile_txt{'92'} $curuser</b></a></p></span>
~;
	}
