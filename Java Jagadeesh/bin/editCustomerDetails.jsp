...
<%
   try
	...
	try
	{
		...
		String oldUserID = request.getParameter("selectCustNames");
	...
	<BODY>
		...
		<CENTER>
		  ...
		  <tr><td align=right height=30 class=text>CustID :</td>
			  <td class=text><INPUT TYPE="Text" name="txtCustID" value="<%=rs.getString(1)%>" class=text></td>
		  </tr>
		  ...
		  <tr><td align=right height=30 class=text>Email :</td>
		      <td class=text><INPUT TYPE="combo" Size=20 name="txtEmail" value="<%=rs.getInt(3)%>" class=text></td>
		  </tr>
