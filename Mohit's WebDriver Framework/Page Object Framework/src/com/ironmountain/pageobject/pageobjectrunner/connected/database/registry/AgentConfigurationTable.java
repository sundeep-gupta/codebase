...
public class AgentConfigurationTable extends RegistyDatabase{
	...
	public void updateProfileandWebsiteSettings(String webSiteSettingsId, String id) {
		String query = "UPDATE AgentConfiguration SET AgentWebSiteSettingsID = " + webSiteSettingsId + " WHERE ID = " + id;
		logger.info(query);
		int res = queryExecutor.executeUpdate(query);
		if (res==0){
