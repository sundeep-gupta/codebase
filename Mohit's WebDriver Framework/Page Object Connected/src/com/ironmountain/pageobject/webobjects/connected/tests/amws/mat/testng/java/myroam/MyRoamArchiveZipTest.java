...
/** Test to verify the my roam archive zip format feature
 * @author pjames
 *
 */
@SeleniumUITest
public class MyRoamArchiveZipTest extends AccountManagementTest {
	...
	/** Tests to verify the My Roam Archive zip format
	 * @param Email
	 * @param Password
	...
	public void testMyRoamArchiveFormats(String searchText, String windowsZipText,String windowsExeText) throws Exception
	{
		...
		myRoamPage.selectArchiveFormat(windowsZipText);
