...
public class CdqTable extends RegistyDatabase{
	...
	public int getTotalMediaOrdered(String accountNumber){
		String colName = "*";
		String query = createSelectQuery(colName, TABLE_NAME, "Account = "+accountNumber);
		logger.debug("MediaType Query generated: " + query);
		ResultSet rs = queryExecutor.executeQuery(query);
		int totalMedia = ResultSetManager.getNoOfRowsInResultSet(rs);
		logger.debug(": " + totalMedia);
		return totalMedia ;
	}
