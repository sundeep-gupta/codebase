...
$.reject = function(options) {
	var opts = $.extend(true,{
      ...
      all: false, // Covers Everything (Nothing blocked)
			msie5: true, msie9: false, msie8:true, msie7: true, msie6: true// Covers MSIE 5-6 (Blocked by default)
			/*
		...
		// Paragraph 1
		paragraph1: 'We sincerely apologize for not supporting your current browser. We are trying our best to enable support for as many browser flavors as possible.',
		// Paragraph 2
		paragraph2: 'Please click on icons below to download compatible browser or try accessing with Firefox/Chrome if already installed..',
		close: true, // Allow closing of window
		// Message displayed below closing link
		closeMessage: 'Thank you for considering our request!',
