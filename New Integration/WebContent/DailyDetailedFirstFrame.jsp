...
//document.getElementById("one").src="/NewIntegration/run?__report=DailyDetailedChartReport.rptdesign&sidParam=<%= serviceId %>&uidParam=<%= userId %>&cityParam=" + SelectedLocation;
