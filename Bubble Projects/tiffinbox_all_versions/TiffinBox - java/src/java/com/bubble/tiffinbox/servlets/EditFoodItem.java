...
public class EditFoodItem extends HttpServlet {
    ...
    throws ServletException, IOException {        
        ...
        String message = "";
        String sql = "UPDATE food_items SET description=?, price=? WHERE ID = ?";
        ...
        try {
            ...
            pStatement.setString(1, foodItem.getDesc());
            pStatement.setInt(2, foodItem.getPrice());
            pStatement.setInt(3, foodItem.getId());
