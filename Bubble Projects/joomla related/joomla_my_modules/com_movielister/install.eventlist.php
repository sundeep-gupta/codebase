...
function com_install() {
    $installer = new MovieListerInstaller('color:#0f0;', 'color:#f00;font-weight:bold;', 'color:#f72;');
    ...
    echo '<p>For support documentation and getting started information, please see <a href="http://www.crea2ive.com/" onclick="javascript:window.open(\'http://www.crea2ive.com\', \'_blank\', \'\', false);return false;">http://simplestforum.org/</a>.</p>';

    return $failures == 0;
} //end com_install

class MovieListerInstaller
{
    var $_log;
    var $_errors;
    var $_warnings;
