...
<div class="Post">
		...
		<?php if ($hasCaption): ?>
<h2 class="PostHeaderIcon-wrapper"><?php echo JHTML::_('image.site', 'PostHeaderIcon.png', null, null, null, JText::_("PostHeaderIcon"), array('width' => '12', 'height' => '12')); ?> <span class="PostHeader">
		<?php echo $caption; ?>
</span>
		</h2>
