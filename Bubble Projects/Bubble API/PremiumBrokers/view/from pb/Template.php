...
class Header extends Div{
	...
	$data = '<h1 id="logo" style="position: absolute; left: 33; top: 16">
		...
		<h2 id="slogan" style="position: absolute; left: 398px; top: 26px">... Valuing relations ... forever !!</h2>';
	$this->add_data($data);		
	$menu = new UList();
...
<![endif]-->
			...
			<h1>Testimonials</h1>
			<p>Highly responsive team of Premium Brokers helped us to develop their Web Portal within 3 Weeks !!! --Bubble Team, Bubble Inc.,</p>';
	$this->add_data($data);
    }
}
