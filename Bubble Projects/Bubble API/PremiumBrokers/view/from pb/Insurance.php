...
class Insurance extends Div{
  ...
  <p class="style1" >Premium Brokers has tied up with 
Priority Circle Prudential ICICI for General &amp; Life Insurance</p>
<p class="style1" >We offer following 
services,
...
cover to suit client\'s exposure / requirements </p>
<ul>
	<li>
	<p class="style1" >Ensure timely payment of 
the premiums and timely renewals </p>
	</li>
	<li>
	<p class="style1" >Maintain records of the Clients\' 
insurance portfolio and review the same from time to time </p>
	</li>
	<li>
	<p class="style1">In the event of 
