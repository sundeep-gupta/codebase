...
class RightMenu extends Div {
	...
	parent::__construct( $attr );
     ...
     <p class="style2">
<a href="http://www.aksharbharati.org/drupal/node/83" >
<strong>Click here</strong> for Annual Day Report</a></p>
<p class="style2">
<a href="http://www.aksharbharati.org/drupal/node/41" >
<strong>Click here</strong> to read latest Press Report</a></p>
<p class="style2">
<a href="http://www.aksharbharati.org/drupal" >
<strong>Click here</strong> to access AB Community</a></p>
<p>&nbsp;</p>
    ';
		$this->add_data($data);
    }
