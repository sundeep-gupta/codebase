...
class About extends Div{
	...
	$data = '<h1>About <span class="green">Premium Brokers</span></h1>
			  ...
			  <p class="style1">Established in Feb 
...
Real Estates, Training and allied services. <br><br>The strengths of Premium Brokers 
...
services <br><br>The following core team consists of experts in Finance domain with 
rich experience in capital markets and real estates,<br><br>-><strong>Preetam Lunawat  
