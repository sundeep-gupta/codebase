...
=head1 APPLICATIONS
run: softboost_007.pl -s <acc_host> -e <non_acc_host>
...
is (run_iperf($host, $excluded_host, "-t $duration -P $sessions ") , 1, "Softboost: Include & Exclude TCP ") ;
...
#Start Iperf for excluded sessions
    ...
    print $OUTPUT "INVOKE TCP IPERF: $iperf_excluded \n";
