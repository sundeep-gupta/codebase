...
<body bgcolor="#EFF4F9" onload="" leftmargin="0" topmargin="0" marginwidth="0" marginheight="0">
    <form name="selectServiceForm">
        <table width="100%" border="0" height=127 cellpadding="0" cellspacing="0" background="images/cust_CFP_top_bar.gif">
        <tr>
           <td>
                <table width="100%" height="60" border="0" cellpadding="0" cellspacing="0" >
                <tr> 
                    <td width="50%"><p>&nbsp;</p><p>&nbsp;</p></td>
                    <td width="50%" align="right">
                        <p><img src="images/applogo.gif" width="166" height="54"></p>
                        <p><u><a href="logout.jsp" target=_top><br><b>logout<a></b></u></p>
                    </td>
                </tr>
                </table>
            </td>
	...
	<tr>
            <td bgcolor="#EFF4F9" align="center">
                ...
                <tr>
                    <td height="25" align="left" valign="middle" class="tabheading" >
                        &nbsp;&nbsp;WELCOME TO PERFORMANCE MONITORING SUITE
                    </td>
                    <TD class="tabheading" ALIGN="RIGHT">
                        Hello &nbsp;&nbsp;<font CLASS="HEADDB"><%=session.getAttribute("username")%>!!&nbsp;&nbsp;&nbsp;&nbsp;</font>
                    </TD>	
        	</tr>
                <tr>
                    <td>
			...
			<tr>
                            <td colspan=2 class="heading">Service specifications</td>
                        </tr>
                        <tr>
                            <td colspan=2>&nbsp;</td>
                        </tr>
                        <tr>
                            <td colspan=2 class="runningtext">
                                <p>AppLabs' business process performance monitoring helps you to monitor your critical and frequently used business processes. The monitoring frequency and the monitoring location are configurable based on the customer needs. The monitors collect end to end performance metrics and provide feedback on the trends in customer usage, service availability, end user experience by geographic location, quality of service and initial diagnosis to pinpoint problems.  The service also provides instant notification via e-mail on service failure.   Customer provides the URL's and business processes to be monitored, locations from which the monitoring is carried out and the frequency of monitoring.<s/p>
                            </td>
                        </tr>
			<tr>
                            <td colspan=2>&nbsp;</td>
			...
			<tr>
                            <td colspan=2 class="runningtext">
                                    <b>Please contact for any clarifications</b> <a href="mailto:performancesupport@applabs.com"><font  color="blue" >performancesupport@applabs.com</a>
                            </td>
                        </tr>
                        </table>
                    </td>
			...
			<tr> 
                            ...
                            <td width="47%" height="30" align=left>
                                <SELECT name="selectServiceOptions" class="select" onChange=" javascript:displayDailySummary()">
                                    <option value="">Select Service</option>
<%	
    try {
        con = getConnection();
        stmt = con.createStatement();
        String sqlString = "select serviceid,sitename from monitoringspecifications where custid="+custID;
