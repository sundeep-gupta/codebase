<!--To Delete customer details from the Database User Interface page -->
...
<BODY>
	<CENTER>
        <form name=deleteCustomerFrm onSubmit="return checkOnSubmit(deleteCustomerFrm);" action="deleteCustomerDetails.jsp" method=post> 
...
try
	{
		...
		//Get the Customer names to display in the Dropdown list
