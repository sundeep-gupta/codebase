...
sub confirm_delete
{
    my $template = HTML::Template->new(filename=>'confirmClient.tmpl');
    my $id = '';
    my $name = '';
    ...
    my $client_string = "SELECT ClientID, Name
		       FROM clients WHERE ClientID ='$chosen_client'";
...
sub delete_worker 
{
    ...
    #create sql string and execute it (Client)
    my $delete_client = "DELETE FROM clients WHERE ClientID = '$id'";
