...
# 
# Script ID:			MCR-141
# Script Name:			MCR-141.pl
# Description:			Verifies compression-ratio of non-compressible-data transferred using CIFS from server to client at second level of compression
...
if ($help) {
	print "Usage: #perl mcr-141.pl [ --size  <size of file>
