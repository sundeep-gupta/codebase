...
#
# Script ID:			MCR-192
# Script Name:			MCR-192.pl
# Description:			Verifies mid-compression-ratio of compressible-data transferred using FTP in multi-session [different set of data] from server to client at first level of compression
...
if ($help) {
	print "Usage: #perl mcr-192.pl [--size  <size of file>
