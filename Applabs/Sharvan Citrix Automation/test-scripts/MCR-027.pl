...
# 
# Script ID:			MCR-027
# Script Name:			MCR-027.pl
# Description:			Verifies integrity of compressible-data transferred using wget ftp from server to client at second level of compression
...
if ($help) {
	print "Usage: #perl mcr-027.pl [ --stype <type of system, script is running on>
