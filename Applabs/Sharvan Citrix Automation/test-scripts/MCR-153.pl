...
#
# Script ID:			MCR-153
# Script Name:			MCR-153.pl
# Description:			Verifies compression-ratio of compressible-data transferred using wget FTP in multi-session [same data] from server to client at first level of compression
...
if ($help) {
	print "Usage: #perl mcr-153.pl [--size  <size of file>
