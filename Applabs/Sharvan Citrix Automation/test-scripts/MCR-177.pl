...
#
# Script ID:			MCR-177
# Script Name:			MCR-177.pl
# Description:			Verifies compression-ratio of non-compressible-data transferred using CIFS in multi-session [same data] from server to client at second level of compression
...
if ($help) {
	print "Usage: #perl mcr-177.pl [--size  <size of file>
