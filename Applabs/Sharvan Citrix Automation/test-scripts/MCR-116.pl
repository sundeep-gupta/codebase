...
# 
# Script ID:			MCR-116
# Script Name:			MCR-116.pl
# Description:			Verifies compression-ratio of compressible-data transferred using FTP from server to client at first level of compression
...
if ($help) {
	print "Usage: #perl mcr-116.pl [ --size  <size of file>
