...
# 
# Script ID:			MCR-126
# Script Name:			MCR-126.pl
# Description:			Verifies compression-ratio of non-compressible-data transferred using wget HTTP from server to client at first level of compression
...
if ($help) {
	print "Usage: #perl mcr-126.pl [ --size  <size of file>
