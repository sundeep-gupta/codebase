...
#
# Script ID:			MCR-147
# Script Name:			MCR-147.pl
# Description:			Verifies compression-ratio of mid-compressible-data transferred using CIFS in multi-session [same data] from client to server at first level of compression
...
if ($help) {
	print "Usage: #perl mcr-147.pl [--size  <size of file>
