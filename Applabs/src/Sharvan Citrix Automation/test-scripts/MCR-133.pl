...
# 
# Script ID:			MCR-133
# Script Name:			MCR-133.pl
# Description:			Verifies compression-ratio of compressible-data transferred using CIFS from server to client at second level of compression
...
if ($help) {
	print "Usage: #perl mcr-133.pl [ --size  <size of file>
