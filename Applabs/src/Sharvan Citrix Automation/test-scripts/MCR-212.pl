...
#
# Script ID:			MCR-212
# Script Name:			MCR-212.pl
# Description:			Verifies compression-ratio of mid-compressible-data transferred using wget HTTP in multi-session [different set of data] from server to client at second level of compression
...
if ($help) {
	print "Usage: #perl mcr-212.pl [--size  <size of file>
