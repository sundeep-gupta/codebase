...
# 
# Script ID:			MCR-115
# Script Name:			MCR-115.pl
# Description:			Verifies compression-ratio of compressible-data transferred using CIFS from server to client at first level of compression
...
if ($help) {
	print "Usage: #perl mcr-115.pl [ --size  <size of file>
