...
#
# Script ID:			MCR-187
# Script Name:			MCR-187.pl
# Description:			Verifies compression-ratio of compressible-data transferred using CIFS in multi-session [different set of data] from server to client at first level of compression
...
if ($help) {
	print "Usage: #perl mcr-187.pl [--size  <size of file>
