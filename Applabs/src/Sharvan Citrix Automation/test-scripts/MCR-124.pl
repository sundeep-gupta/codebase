...
# 
# Script ID:			MCR-124
# Script Name:			MCR-124.pl
# Description:			Verifies compression-ratio of non-compressible-data transferred using FTP from server to client at first level of compression
...
if ($help) {
	print "Usage: #perl mcr-124.pl [ --size  <size of file>
