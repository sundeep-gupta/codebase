...
#
# Script ID:			MCR-191
# Script Name:			MCR-191.pl
# Description:			Verifies compression-ratio of mid-compressible-data transferred using CIFS in multi-session [different set of data] from server to client at first level of compression
...
if ($help) {
	print "Usage: #perl mcr-191.pl [--size  <size of file>
