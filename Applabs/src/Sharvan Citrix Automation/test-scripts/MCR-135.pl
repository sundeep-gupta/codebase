...
# 
# Script ID:			MCR-135
# Script Name:			MCR-135.pl
# Description:			Verifies compression-ratio of compressible-data transferred using wget FTP from client to server at second level of compression
...
if ($help) {
	print "Usage: #perl mcr-135.pl [ --size  <size of file>
