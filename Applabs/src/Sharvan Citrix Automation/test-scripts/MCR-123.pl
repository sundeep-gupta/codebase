...
# 
# Script ID:			MCR-123
# Script Name:			MCR-123.pl
# Description:			Verifies compression-ratio of non-compressible-data transferred using CIFS from server to client at first level of compression
...
if ($help) {
	print "Usage: #perl mcr-123.pl [ --size  <size of file>
