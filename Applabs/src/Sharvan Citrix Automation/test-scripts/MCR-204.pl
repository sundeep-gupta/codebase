...
#
# Script ID:			MCR-204
# Script Name:			MCR-204.pl
# Description:			Verifies compression-ratio of non-compressible-data transferred using FTP in multi-session [different set of data] from client to server at second level of compression
...
if ($help) {
	print "Usage: #perl mcr-204.pl [--size  <size of file>
