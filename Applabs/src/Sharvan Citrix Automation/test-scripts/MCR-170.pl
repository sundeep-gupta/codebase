...
#
# Script ID:			MCR-170
# Script Name:			MCR-170.pl
# Description:			Verifies compression-ratio of compressible-data transferred using FTP in multi-session [same data] from server to client at second level of compression
...
if ($help) {
	print "Usage: #perl mcr-170.pl [--size  <size of file>
