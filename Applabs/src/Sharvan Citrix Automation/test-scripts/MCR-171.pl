...
#
# Script ID:			MCR-171
# Script Name:			MCR-171.pl
# Description:			Verifies compression-ratio of compressible-data transferred using wget FTP in multi-session [same data] from server to client at second level of compression
...
if ($help) {
	print "Usage: #perl mcr-171.pl [--size  <size of file>
