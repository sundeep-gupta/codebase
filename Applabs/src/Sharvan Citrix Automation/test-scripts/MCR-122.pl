...
# 
# Script ID:			MCR-122
# Script Name:			MCR-122.pl
# Description:			Verifies compression-ratio of mid-compressible-data transferred using wget HTTP from server to client at first level of compression
...
if ($help) {
	print "Usage: #perl mcr-122.pl [ --size  <size of file>
