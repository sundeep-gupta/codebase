...
# 
# Script ID:			MCR-117
# Script Name:			MCR-117.pl
# Description:			Verifies compression-ratio of compressible-data transferred using wget FTP from server to client at first level of compression
...
if ($help) {
	print "Usage: #perl mcr-117.pl [ --size  <size of file>
