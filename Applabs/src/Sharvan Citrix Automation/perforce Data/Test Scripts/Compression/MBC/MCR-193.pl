...
#
# Script ID:			MCR-193
# Script Name:			MCR-193.pl
# Description:			Verifies compression-ratio of mid-compressible-data transferred using wget FTP in multi-session [different set of data] from server to client at first level of compression
...
if ($help) {
	print "Usage: #perl mcr-193.pl [--size  <size of file>
