...
#
# Script ID:			MCR-172
# Script Name:			MCR-172.pl
# Description:			Verifies compression-ratio of compressible-data transferred using wget HTTP in multi-session [same data] from server to client at second level of compression
...
if ($help) {
	print "Usage: #perl mcr-172.pl [--size  <size of file>
