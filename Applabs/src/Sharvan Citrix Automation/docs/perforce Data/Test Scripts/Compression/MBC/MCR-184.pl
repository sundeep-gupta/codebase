...
#
# Script ID:			MCR-184
# Script Name:			MCR-184.pl
# Description:			Verifies compression-ratio of mid-compressible-data transferred using FTP in multi-session [different set of data] from client to server at first level of compression
...
if ($help) {
	print "Usage: #perl mcr-184.pl [--size  <size of file>
