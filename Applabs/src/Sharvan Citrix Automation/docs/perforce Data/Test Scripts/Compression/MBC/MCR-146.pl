...
#
# Script ID:			MCR-146
# Script Name:			MCR-146.pl
# Description:			Verifies compression-ratio of compressible-data transferred using FTP in multi-session [same data] from client to server at first level of compression
...
if ($help) {
	print "Usage: #perl mcr-146.pl [--size  <size of file>
