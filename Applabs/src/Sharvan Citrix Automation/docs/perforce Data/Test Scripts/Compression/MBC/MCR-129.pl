...
# 
# Script ID:			MCR-129
# Script Name:			MCR-129.pl
# Description:			Verifies compression-ratio of mid-compressible-data transferred using CIFS from client to server at second level of compression
...
if ($help) {
	print "Usage: #perl mcr-129.pl [ --size  <size of file>
