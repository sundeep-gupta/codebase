...
#
# Script ID:			MCR-178
# Script Name:			MCR-178.pl
# Description:			Verifies compression-ratio of non-compressible-data transferred using FTP in multi-session [same data] from server to client at second level of compression
...
if ($help) {
	print "Usage: #perl mcr-178.pl [--size  <size of file>
