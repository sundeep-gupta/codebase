...
#
# Script ID:			MCR-156
# Script Name:			MCR-156.pl
# Description:			Verifies compression-ratio of mid-compressible-data transferred using FTP in multi-session [same data] from server to client at first level of compression
...
if ($help) {
	print "Usage: #perl mcr-156.pl [--size  <size of file>
