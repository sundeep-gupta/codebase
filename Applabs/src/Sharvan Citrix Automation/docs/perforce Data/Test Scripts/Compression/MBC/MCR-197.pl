...
#
# Script ID:			MCR-197
# Script Name:			MCR-197.pl
# Description:			Verifies compression-ratio of non-compressible-data transferred using wget FTP in multi-session [different set of data] from server to client at first level of compression
...
if ($help) {
	print "Usage: #perl mcr-197.pl [--size  <size of file>
