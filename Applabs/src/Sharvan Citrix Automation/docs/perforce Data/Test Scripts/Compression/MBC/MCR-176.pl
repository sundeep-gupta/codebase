...
#
# Script ID:			MCR-176
# Script Name:			MCR-176.pl
# Description:			Verifies compression-ratio of mid-compressible-data transferred using wget HTTP in multi-session [same data] from server to client at second level of compression
...
if ($help) {
	print "Usage: #perl mcr-176.pl [--size  <size of file>
