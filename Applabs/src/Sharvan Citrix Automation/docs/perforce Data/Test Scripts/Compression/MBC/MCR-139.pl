...
# 
# Script ID:			MCR-139
# Script Name:			MCR-139.pl
# Description:			Verifies compression-ratio of mid-compressible-data transferred using wget FTP from client to server at second level of compression
...
if ($help) {
	print "Usage: #perl mcr-139.pl [ --size  <size of file>
