...
#
# Script ID:			MCR-185
# Script Name:			MCR-185.pl
# Description:			Verifies compression-ratio of non-compressible-data transferred using CIFS in multi-session [different set of data] from client to server at first level of compression
...
if ($help) {
	print "Usage: #perl mcr-185.pl [--size  <size of file>
...
my ($file, $ref_source_checksums, $target_checksum, $ctr, $ref_files, $first_pass);
