...
#
# Script ID:			MCR-202
# Script Name:			MCR-202.pl
# Description:			Verifies compression-ratio of mid-compressible-data transferred using FTP in multi-session [different set of data] from client to server at second level of compression
...
if ($help) {
	print "Usage: #perl mcr-202.pl [--size  <size of file>
