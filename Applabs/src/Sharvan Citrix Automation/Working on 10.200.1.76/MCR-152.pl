...
#
# Script ID:			MCR-152
# Script Name:			MCR-152.pl
# Description:			Verifies compression-ratio of compressible-data transferred using FTP in multi-session [same data] from server to client at first level of compression
...
if ($help) {
	print "Usage: #perl mcr-152.pl [--size  <size of file>
