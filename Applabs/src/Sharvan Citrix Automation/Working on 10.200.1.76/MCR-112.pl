...
# 
# Script ID:			MCR-112
# Script Name:			MCR-112.pl
# Description:			Verifies compression-ratio of mid-compressible-data transferred using FTP from client to server at first level of compression
...
if ($help) {
	print "Usage: #perl mcr-112.pl [ --size  <size of file>
