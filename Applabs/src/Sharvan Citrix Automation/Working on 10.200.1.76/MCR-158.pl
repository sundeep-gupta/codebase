...
#
# Script ID:			MCR-158
# Script Name:			MCR-158.pl
# Description:			Verifies compression-ratio of mid-compressible-data transferred using wget HTTP in multi-session [same data] from server to client at first level of compression
...
if ($help) {
	print "Usage: #perl mcr-158.pl [--size  <size of file>
