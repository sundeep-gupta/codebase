...
#
# Script ID:			MCR-189
# Script Name:			MCR-189.pl
# Description:			Verifies compression-ratio of compressible-data transferred using wget FTP in multi-session [different set of data] from server to client at first level of compression
...
if ($help) {
	print "Usage: #perl mcr-189.pl [--size  <size of file>
