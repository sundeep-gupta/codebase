...
#
# Script ID:			MCR-216
# Script Name:			MCR-216.pl
# Description:			Verifies compression-ratio of non-compressible-data transferred using wget HTTP in multi-session [different set of data] from server to client at second level of compression
...
if ($help) {
	print "Usage: #perl mcr-216.pl [--size  <size of file>
