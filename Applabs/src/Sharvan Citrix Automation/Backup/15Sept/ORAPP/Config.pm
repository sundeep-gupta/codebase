...
sub new {
    ...
    my $CONFIG = {
		"ORBITAL1"		  => "10.1.1.4",							 # Orbital 1 IP address; will come from console
		"ORBITAL2"		  => "10.1.2.4",							 # Orbital 2 IP address; will come from console
		"SERVER"		  => "10.1.1.3",							 # Server IP; will come from console
		...
		"WAN_SIMULATOR"	  => "10.200.199.156",						 # WAN Simulator IP address; will come from console
        ...
        "FTP_USER"        => "Administrator",                                     # [console] User name of the FTP server
        "FTP_PASSWORD"    => "ARS!jr",                                     # [console] Password of the FTP server user
