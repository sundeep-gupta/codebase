...
# 
# Script ID:			MCR-018
# Script Name:			MCR-018.pl
# Description:			Verifies integrity of non-compressible-data transferred using wget http from server to client at first level of compression
...
if ($help) {
	print "Usage: #perl cr-018.pl [ --stype <type of system, script is running on>
