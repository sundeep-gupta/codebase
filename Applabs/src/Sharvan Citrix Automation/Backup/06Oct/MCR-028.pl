...
# 
# Script ID:			MCR-028
# Script Name:			MCR-028.pl
# Description:			Verifies integrity of compressible-data transferred using wget http from server to client at second level of compression
...
if ($help) {
	print "Usage: #perl cr-028.pl [ --stype <type of system, script is running on>
