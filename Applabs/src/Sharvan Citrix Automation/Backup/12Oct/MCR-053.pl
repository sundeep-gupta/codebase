...
# 
# Script ID:			MCR-053
# Script Name:			MCR-053.pl
# Description:			Verifies integrity of non-compressible-data transferred using wget ftp in multi-session [same data] from server to client at first level of compression
...
if ($help) {
	print "Usage: #perl mcr-053.pl [ --stype <type of system, script is running on>
