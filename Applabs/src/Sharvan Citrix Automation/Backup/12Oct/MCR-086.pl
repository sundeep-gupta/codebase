...
# 
# Script ID:			MCR-086
# Script Name:			MCR-086.pl
# Description:			Verifies integrity of mid-compressible-data transferred using wget http in multi-session [different set of data] from server to client at first level of compression
...
if ($help) {
	print "Usage: #perl mcr-086.pl [ --stype <type of system, script is running on>
