...
# 
# Script ID:			MCR-089
# Script Name:			MCR-089.pl
# Description:			Verifies integrity of non-compressible-data transferred using wget ftp in multi-session [different set of data] from server to client at first level of compression
...
if ($help) {
	print "Usage: #perl mcr-089.pl [ --stype <type of system, script is running on>
