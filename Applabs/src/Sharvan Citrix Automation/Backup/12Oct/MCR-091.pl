...
# 
# Script ID:			MCR-091
# Script Name:			MCR-091.pl
# Description:			Verifies integrity of compressible-data transferred using CIFS in multi-session [different set of data] from client to server at second level of compression
...
if ($help) {
	print "Usage: #perl mcr-091.pl [ --stype <type of system, script is running on>
