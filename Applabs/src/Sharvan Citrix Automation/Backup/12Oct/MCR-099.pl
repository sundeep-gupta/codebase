...
# 
# Script ID:			MCR-099
# Script Name:			MCR-099.pl
# Description:			Verifies integrity of compressible-data transferred using wget ftp in multi-session [different set of data] from server to client at second level of compression
...
if ($help) {
	print "Usage: #perl mcr-099.pl [ --stype <type of system, script is running on>
