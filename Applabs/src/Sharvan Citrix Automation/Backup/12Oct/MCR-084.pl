...
# 
# Script ID:			MCR-084
# Script Name:			MCR-084.pl
# Description:			Verifies integrity of mid-compressible-data transferred using FTP in multi-session [different set of data] from server to client at first level of compression
...
if ($help) {
	print "Usage: #perl mcr-084.pl [ --stype <type of system, script is running on>
