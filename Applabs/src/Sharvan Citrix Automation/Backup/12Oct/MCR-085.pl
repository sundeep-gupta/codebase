...
# 
# Script ID:			MCR-085
# Script Name:			MCR-085.pl
# Description:			Verifies integrity of mid-compressible-data transferred using wget ftp in multi-session [different set of data] from server to client at first level of compression
...
if ($help) {
	print "Usage: #perl mcr-085.pl [ --stype <type of system, script is running on>
