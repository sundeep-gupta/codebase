...
# 
# Script ID:			MCR-061
# Script Name:			MCR-061.pl
# Description:			Verifies integrity of compressible-data transferred using CIFS in multi-session [same data] from server to client at second level of compression
...
if ($help) {
	print "Usage: #perl mcr-061.pl [ --stype <type of system, script is running on>
