...
# 
# Script ID:			MCR-065
# Script Name:			MCR-065.pl
# Description:			Verifies integrity of mid-compressible-data transferred using CIFS in multi-session [same data] from server to client at second level of compression
...
if ($help) {
	print "Usage: #perl mcr-065.pl [ --stype <type of system, script is running on>
