...
# 
# Script ID:			MCR-056
# Script Name:			MCR-056.pl
# Description:			Verifies integrity of compressible-data transferred using FTP in multi-session [same data] from client to server at second level of compression
...
if ($help) {
	print "Usage: #perl mcr-056.pl [ --stype <type of system, script is running on>
