...
# 
# Script ID:			MCR-035
# Script Name:			MCR-035.pl
# Description:			Verifies integrity of non-compressible-data transferred using wget ftp from server to client at second level of compression
...
if ($help) {
	print "Usage: #perl mcr-035.pl [ --stype <type of system, script is running on>
