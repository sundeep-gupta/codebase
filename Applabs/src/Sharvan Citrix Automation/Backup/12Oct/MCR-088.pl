...
# 
# Script ID:			MCR-088
# Script Name:			MCR-088.pl
# Description:			Verifies integrity of non-compressible-data transferred using FTP in multi-session [different set of data] from server to client at first level of compression
...
if ($help) {
	print "Usage: #perl mcr-088.pl [ --stype <type of system, script is running on>
