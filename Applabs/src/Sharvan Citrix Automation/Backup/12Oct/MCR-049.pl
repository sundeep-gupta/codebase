...
# 
# Script ID:			MCR-049
# Script Name:			MCR-049.pl
# Description:			Verifies integrity of mid-compressible-data transferred using wget ftp in multi-session [same data] from server to client at first level of compression
...
if ($help) {
	print "Usage: #perl mcr-049.pl [ --stype <type of system, script is running on>
