...
# 
# Script ID:			MCR-073
# Script Name:			MCR-073.pl
# Description:			Verifies integrity of compressible-data transferred using CIFS in multi-session [different set of data] from client to server at first level of compression
...
if ($help) {
	print "Usage: #perl mcr-073.pl [--size  <size of file>
