...
# 
# Script ID:			MCR-044
# Script Name:			MCR-044.pl
# Description:			Verifies integrity of compressible-data transferred using FTP in multi-session [same data] from server to client at first level of compression
...
if ($help) {
	print "Usage: #perl cr-044.pl [ --stype <type of system, script is running on>
