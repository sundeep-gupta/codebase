...
# 
# Script ID:			MCR-076
# Script Name:			MCR-076.pl
# Description:			Verifies integrity of mid-compressible-data transferred using FTP in multi-session [different set of data] from client to server at first level of compression
...
if ($help) {
	print "Usage: #perl mcr-076.pl [ --stype <type of system, script is running on>
