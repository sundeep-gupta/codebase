...
#
# Script ID:			MCR-183
# Script Name:			MCR-183.pl
# Description:			Verifies compression-ratio of mid-compressible-data transferred using CIFS in multi-session [different set of data] from client to server at first level of compression
...
if ($help) {
	print "Usage: #perl mcr-183.pl [--size  <size of file>
