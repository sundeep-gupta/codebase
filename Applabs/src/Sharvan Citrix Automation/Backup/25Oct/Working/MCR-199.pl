...
#
# Script ID:			MCR-199
# Script Name:			MCR-199.pl
# Description:			Verifies compression-ratio of compressible-data transferred using CIFS in multi-session [different set of data] from client to server at second level of compression
...
if ($help) {
	print "Usage: #perl mcr-199.pl [--size  <size of file>
