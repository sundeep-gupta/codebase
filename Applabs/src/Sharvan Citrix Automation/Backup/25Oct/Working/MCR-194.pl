...
#
# Script ID:			MCR-194
# Script Name:			MCR-194.pl
# Description:			Verifies compression-ratio of mid-compressible-data transferred using wget HTTP in multi-session [different set of data] from server to client at first level of compression
...
if ($help) {
	print "Usage: #perl mcr-194.pl [--size  <size of file>
