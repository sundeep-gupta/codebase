...
# 
# Script ID:			MCR-118
# Script Name:			MCR-118.pl
# Description:			Verifies compression-ratio of compressible-data transferred using wget HTTP from server to client at first level of compression
...
if ($help) {
	print "Usage: #perl mcr-118.pl [ --size  <size of file>
