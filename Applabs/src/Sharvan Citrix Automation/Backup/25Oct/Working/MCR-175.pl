...
#
# Script ID:			MCR-175
# Script Name:			MCR-175.pl
# Description:			Verifies compression-ratio of mid-compressible-data transferred using wget FTP in multi-session [same data] from server to client at second level of compression
...
if ($help) {
	print "Usage: #perl mcr-175.pl [--size  <size of file>
