...
# 
# Script ID:			CR-01
# Script Name:			CR-01.pl
# Description:			Verifies that the BW utilization value after enabling the orbital should be approximately 80% of the BW utilized without orbital enabled. And also the time took for transferring the files should be less than that compared without orbital enabled.
...
if ($help) {
	print "Usage: #perl cr-01.pl [ --stype <type of system, script is running on>
