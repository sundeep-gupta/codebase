...
# 
# Script ID:			MCR-137
# Script Name:			MCR-137.pl
# Description:			Verifies compression-ratio of mid-compressible-data transferred using CIFS from server to client at second level of compression
...
if ($help) {
	print "Usage: #perl mcr-137.pl [ --size  <size of file>
