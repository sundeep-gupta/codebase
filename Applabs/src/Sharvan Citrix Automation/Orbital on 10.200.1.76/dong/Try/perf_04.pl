...
=head1 DESCRIPTION
Verify performance of ORB over: 
a range of predefined BWs & Sessions.
=head2 Test Category
Performance
...
my @sess_list = (1, 5, ,10,20,50, 100,200);                 #Modify this list if needed
my $host = $opt_s;
chomp ($host );
...
my $duration = 60;
my $sess =1;
my $perc = 0.90;                  #expect throughout percentage
