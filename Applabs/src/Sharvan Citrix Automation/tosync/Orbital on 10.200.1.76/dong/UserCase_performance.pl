...
=head NAME
UserCase_performance.pl

=head1 DESCRIPTION
These usercases are provided by PM & Avnish
Case1: 512Kbps, 120Rtt, 0.5%Loss

Case2: 1.5Mbps, 50Rtt, 0.5% Loss

Case3: 15Mbps, 200Rtt, .5%Loss

Case4: 45Mbps, 100Rtt, 0.5%Loss

Case5: 155Mbps, 100Rtt, 0.5 loss
...
my $testcase="UserCase_performance";
%usercases = (
    case_1 => [0.512, 120, 0.5],
    case_2 => [1.5, 50, 0.5],
    case_3 => [15, 200, 0.5],
    case_4 => [45, 100, 0.5],
    case_5 => [155, 100,0.5],
