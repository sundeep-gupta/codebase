...
#
# Script ID:			MCR-200
# Script Name:			MCR-200.pl
# Description:			Verifies compression-ratio of compressible-data transferred using FTP in multi-session [different set of data] from client to server at second level of compression
...
if ($help) {
	print "Usage: #perl mcr-200.pl [--size  <size of file>
