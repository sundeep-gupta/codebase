...
# 
# Script ID:			MCR-125
# Script Name:			MCR-125.pl
# Description:			Verifies compression-ratio of non-compressible-data transferred using wget FTP from server to client at first level of compression
...
if ($help) {
	print "Usage: #perl mcr-125.pl [ --size  <size of file>
