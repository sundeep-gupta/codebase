...
#
# Script ID:			MCR-173
# Script Name:			MCR-173.pl
# Description:			Verifies compression-ratio of mid-compressible-data transferred using CIFS in multi-session [same data] from server to client at second level of compression
...
if ($help) {
	print "Usage: #perl mcr-173.pl [--size  <size of file>
