...
# 
# Script ID:			MCR-143
# Script Name:			MCR-143.pl
# Description:			Verifies compression-ratio of non-compressible-data transferred using wget FTP from client to server at second level of compression
...
if ($help) {
	print "Usage: #perl mcr-143.pl [ --size  <size of file>
