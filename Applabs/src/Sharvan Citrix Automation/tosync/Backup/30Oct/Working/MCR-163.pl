...
#
# Script ID:			MCR-163
# Script Name:			MCR-163.pl
# Description:			Verifies compression-ratio of compressible-data transferred using CIFS in multi-session [same data] from client to server at second level of compression
...
if ($help) {
	print "Usage: #perl mcr-163.pl [--size  <size of file>
