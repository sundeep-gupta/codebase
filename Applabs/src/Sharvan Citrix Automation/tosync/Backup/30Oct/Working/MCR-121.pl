...
# 
# Script ID:			MCR-121
# Script Name:			MCR-121.pl
# Description:			Verifies compression-ratio of mid-compressible-data transferred using wget FTP from server to client at first level of compression
...
if ($help) {
	print "Usage: #perl mcr-121.pl [ --size  <size of file>
