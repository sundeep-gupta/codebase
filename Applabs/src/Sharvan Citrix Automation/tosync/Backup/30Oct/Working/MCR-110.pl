...
# 
# Script ID:			MCR-110
# Script Name:			MCR-110.pl
# Description:			Verifies compression-ratio of compressible-data transferred using FTP from client to server at first level of compression
...
if ($help) {
	print "Usage: #perl mcr-110.pl [ --size  <size of file>
