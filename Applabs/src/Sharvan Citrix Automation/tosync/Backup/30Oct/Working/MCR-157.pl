...
#
# Script ID:			MCR-157
# Script Name:			MCR-157.pl
# Description:			Verifies compression-ratio of mid-compressible-data transferred using wget FTP in multi-session [same data] from server to client at first level of compression
...
if ($help) {
	print "Usage: #perl mcr-157.pl [--size  <size of file>
