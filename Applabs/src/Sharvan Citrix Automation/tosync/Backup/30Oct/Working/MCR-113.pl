...
# 
# Script ID:			MCR-113
# Script Name:			MCR-113.pl
# Description:			Verifies compression-ratio of non-compressible-data transferred using CIFS from client to server at first level of compression
...
if ($help) {
	print "Usage: #perl mcr-113.pl [ --size  <size of file>
