...
# 
# Script ID:			MCR-066
# Script Name:			MCR-066.pl
# Description:			Verifies integrity of mid0compressible-data transferred using FTP in multi-session [same data] from server to client at second level of compression
...
if ($help) {
	print "Usage: #perl cr-066.pl [ --stype <type of system, script is running on>
