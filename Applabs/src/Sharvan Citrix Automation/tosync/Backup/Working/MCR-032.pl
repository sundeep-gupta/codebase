...
# 
# Script ID:			MCR-032
# Script Name:			MCR-032.pl
# Description:			Verifies integrity of mid-compressible-data transferred using wget http from server to client at second level of compression
...
if ($help) {
	print "Usage: #perl cr-032.pl [ --stype <type of system, script is running on>
