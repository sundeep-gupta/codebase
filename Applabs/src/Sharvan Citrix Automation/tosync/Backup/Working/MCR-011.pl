...
# 
# Script ID:			MCR-011
# Script Name:			MCR-011.pl
# Description:			Verifies integrity of mid-compressible-data transferred using CIFS from server to client at first level of compression
...
if ($help) {
	print "Usage: #perl mcr-011.pl [ --stype <type of system, script is running on>
