...
# 
# Script ID:			MCR-017
# Script Name:			MCR-017.pl
# Description:			Verifies integrity of non-compressible-data transferred using wget ftp from server to client at first level of compression
...
if ($help) {
	print "Usage: #perl mcr-017.pl [ --stype <type of system, script is running on>
