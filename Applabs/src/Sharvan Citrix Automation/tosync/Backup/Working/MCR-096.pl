...
# 
# Script ID:			MCR-096
# Script Name:			MCR-096.pl
# Description:			Verifies integrity of non-compressible-data transferred using FTP in multi-session [different set of data] from client to server at second level of compression
...
if ($help) {
	print "Usage: #perl mcr-096.pl [ --stype <type of system, script is running on>
