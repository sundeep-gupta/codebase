...
# 
# Script ID:			MCR-023
# Script Name:			MCR-023.pl
# Description:			Verifies integrity of non-compressible-data transferred using CIFS from client to server at second level of compression
...
if ($help) {
	print "Usage: #perl mcr-023.pl [ --stype <type of system, script is running on>
