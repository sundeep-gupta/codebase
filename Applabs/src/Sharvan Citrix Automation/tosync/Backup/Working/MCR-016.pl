...
# 
# Script ID:			MCR-016
# Script Name:			MCR-016.pl
# Description:			Verifies integrity of non-compressible-data transferred using FTP from server to client at first level of compression
...
if ($help) {
	print "Usage: #perl mcr-016.pl [ --stype <type of system, script is running on>
