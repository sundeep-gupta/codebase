...
# 
# Script ID:			MCR-092
# Script Name:			MCR-092.pl
# Description:			Verifies integrity of compressible-data transferred using FTP in multi-session [different set of data] from client to server at second level of compression
...
if ($help) {
	print "Usage: #perl mcr-092.pl [ --stype <type of system, script is running on>
