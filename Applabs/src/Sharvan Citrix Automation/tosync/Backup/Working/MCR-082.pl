...
# 
# Script ID:			MCR-082
# Script Name:			MCR-082.pl
# Description:			Verifies integrity of compressible-data transferred using wget http in multi-session [different set of data] from server to client at first level of compression
...
if ($help) {
	print "Usage: #perl mcr-082.pl [ --stype <type of system, script is running on>
