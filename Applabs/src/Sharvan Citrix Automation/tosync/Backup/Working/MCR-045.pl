...
# 
# Script ID:			MCR-045
# Script Name:			MCR-045.pl
# Description:			Verifies integrity of compressible-data transferred using wget ftp in multi-session [same data] from server to client at first level of compression
...
if ($help) {
	print "Usage: #perl mcr-045.pl [ --stype <type of system, script is running on>
