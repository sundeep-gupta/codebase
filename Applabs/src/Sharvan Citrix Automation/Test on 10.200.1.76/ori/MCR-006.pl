...
# 
# Script ID:			MCR-006
# Script Name:			MCR-006.pl
# Description:			Verifies integrity of non-compressible-data transferred using FTP from client to server at first level of compression
...
if ($help) {
	print "Usage: #perl mcr-006.pl [ --stype <type of system, script is running on>
