...
#
# Script ID:			MCR-207
# Script Name:			MCR-207.pl
# Description:			Verifies compression-ratio of compressible-data transferred using wget FTP in multi-session [different set of data] from server to client at second level of compression
...
if ($help) {
	print "Usage: #perl mcr-207.pl [--size  <size of file>
