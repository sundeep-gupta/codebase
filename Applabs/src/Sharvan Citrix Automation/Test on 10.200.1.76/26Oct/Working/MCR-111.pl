...
# 
# Script ID:			MCR-111
# Script Name:			MCR-111.pl
# Description:			Verifies compression-ratio of mid-compressible-data transferred using CIFS from client to server at first level of compression
...
if ($help) {
	print "Usage: #perl mcr-111.pl [ --size  <size of file>
