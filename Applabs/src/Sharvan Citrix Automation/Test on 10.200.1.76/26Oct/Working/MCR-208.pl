...
#
# Script ID:			MCR-208
# Script Name:			MCR-208.pl
# Description:			Verifies compression-ratio of compressible-data transferred using wget HTTP in multi-session [different set of data] from server to client at second level of compression
...
if ($help) {
	print "Usage: #perl mcr-208.pl [--size  <size of file>
