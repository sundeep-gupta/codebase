...
**                                                                        **
****************************************************************************
**  $Id: c4.c,v 3.10 2005/04/21 20:09:48 pomakis Exp pomakis $
***************************************************************************/
...
/*
 * size_x and y specifies the size of the matrix of game.
 * num_to_connect specifies the number of cells that a player connects. 
 * ally 4 for C4 and N for C-N
 * win-places  Number of possible combination of wins.
 */
...
/* 
 * number that indicates that the player has won.
 * if any player reaches this number he is winner.
 * */
...
c4_get_version(void)
{
    return "$Id: c4.c,v 3.10 2005/04/21 20:09:48 pomakis Exp pomakis $";
}
